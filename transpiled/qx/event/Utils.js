  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Utils", {
    ...
    statics: {
       ...
       */
      __push__P_54_0: function __push__P_54_0(tracker, newPromise) {
        {
        ...
        "true": function _true(tracker, fn) {
          ...
          if (tracker.promise) {
            if (qx.lang.Type.isPromise(fn)) {
              this.__push__P_54_0(tracker, tracker.promise.then(fn));
            } else {
              var self = this;
              this.__push__P_54_0(tracker, tracker.promise.then(function (result) {
                if (tracker.rejected) {
                  return null;
                }
                result = fn(result);
            ...
            this.__addCatcher__P_54_1(tracker);
            return tracker.promise;
          }
          if (qx.lang.Type.isPromise(fn)) {
            return this.__thenPromise__P_54_2(tracker, fn);
          }
          var result = fn(tracker.result);
          if (qx.lang.Type.isPromise(result)) {
            return this.__thenPromise__P_54_2(tracker, result);
          }
       ...
       * @return {qx.Promise} the new promise
       */
      __thenPromise__P_54_2: function __thenPromise__P_54_2(tracker, newPromise) {
        if (tracker.promise) {
          this.__push__P_54_0(tracker, tracker.promise.then(function () {
            return newPromise;
          }));
        } else {
          this.__push__P_54_0(tracker, newPromise);
        }
        this.__addCatcher__P_54_1(tracker);
        return tracker.promise;
      },
      ...
      reject: function reject(tracker) {
        ...
        var result = this.__catcher__P_54_3(tracker);
       ...
       * @param tracker {Object} the tracker object
       */
      __addCatcher__P_54_1: function __addCatcher__P_54_1(tracker) {
        if (tracker.promise && tracker["catch"]) {
          if (!tracker.promise["qx.event.Utils.hasCatcher"]) {
            this.__push__P_54_0(tracker, tracker.promise["catch"](this.__catcher__P_54_3.bind(this, tracker)));
       ...
       * @param tracker {Object} the tracker object
       */
      __catcher__P_54_3: function __catcher__P_54_3(tracker, err) {
...
//# sourceMappingURL=Utils.js.map?dt=1747169152541
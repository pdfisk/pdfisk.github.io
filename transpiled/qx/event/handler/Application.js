  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__domReady__P_40_0 = false;
      this.__loaded__P_40_1 = false;
      this.__isReady__P_40_2 = false;
      this.__isInitialized__P_40_3 = false;
      this.__isUnloaded__P_40_4 = false;
    ...
    */
    ...
    statics: {
      ...
      onAppInstanceInitialized: function onAppInstanceInitialized() {
        var inst = qx.event.handler.Application.$$instance;
        if (inst) {
          inst.__fireAppInstanceInitialized__P_40_6();
        }
      }
    },
    /*
    ...
    */
    ...
    members: {
      ...
      */
      ...
      __isReady__P_40_2: null,
      __isInitialized__P_40_3: null,
      __domReady__P_40_0: null,
      __loaded__P_40_1: null,
      __isUnloaded__P_40_4: null,
      /*
      ---------------------------------------------------------------------------
        USER ACCESS
      ---------------------------------------------------------------------------
      */
       ...
       *
       */
      __fireReady__P_40_5: function __fireReady__P_40_5() {
        // Wrapper qxloader needed to be compatible with old generator
        if (!this.__isReady__P_40_2 && this.__domReady__P_40_0 && qx.$$loader.scriptLoaded) {
       ...
       *
       */
      __fireAppInstanceInitialized__P_40_6: function __fireAppInstanceInitialized__P_40_6() {
        this.__isInitialized__P_40_3 = true;
      ...
      isApplicationInitialized: function isApplicationInitialized() {
        return this.__isInitialized__P_40_3;
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER INIT/STOP
      ...
      */
      ...
      _initObserver: function _initObserver() {
        ...
        if (qx.$$domReady || document.readyState == "complete" || document.readyState == "ready") {
          this.__domReady__P_40_0 = true;
          this.__fireReady__P_40_5();
        } else {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__onNativeLoadHandler__P_40_7),
          "false": this.__onNativeLoadHandler__P_40_7
        });
       ...
       */
      __onNativeLoadHandler__P_40_7: function __onNativeLoadHandler__P_40_7() {
        this.__domReady__P_40_0 = true;
        this.__fireReady__P_40_5();
      },
      /**
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__onNativeUnloadHandler__P_40_8),
          "false": this.__onNativeUnloadHandler__P_40_8
        });
        callback.apply(this, arguments);
      },
      /**
       ...
       */
      __onNativeUnloadHandler__P_40_8: function __onNativeUnloadHandler__P_40_8() {
        if (!this.__isUnloaded__P_40_4) {
          this.__isUnloaded__P_40_4 = true;
          try {
            // Fire user event
...
//# sourceMappingURL=Application.js.map?dt=1747169150851
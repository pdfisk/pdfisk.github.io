  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Idle", {
    ...
    */
    ...
    members: {
      __timer__P_128_0: null,
      // property apply
      _applyTimeoutInterval: function _applyTimeoutInterval(value) {
        if (this.__timer__P_128_0) {
          this.__timer__P_128_0.setInterval(value);
        }
      },
      /**
       ...
       */
      __startTimer__P_128_1: function __startTimer__P_128_1() {
        if (!this.__timer__P_128_0 && this.hasListener("interval")) {
          var timer = new qx.event.Timer(this.getTimeoutInterval());
          timer.addListener("interval", this._onInterval, this);
          timer.start();
          this.__timer__P_128_0 = timer;
        }
      },
      /**
       * Stops the timer but only if there are no listeners for the interval event
       */
      __stopTimer__P_128_2: function __stopTimer__P_128_2() {
        if (this.__timer__P_128_0 && !this.hasListener("interval")) {
          this.__timer__P_128_0.stop();
          this.__timer__P_128_0.dispose();
          this.__timer__P_128_0 = null;
        }
      },
      /*
       * @Override
...
//# sourceMappingURL=Idle.js.map?dt=1747169160405
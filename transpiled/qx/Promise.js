(function () {
  ...
  qx.Class.define("qx.Promise", {
    ...
    construct: function construct(fn, context) {
      ...
      qx.Promise.__initialize__P_38_0();
      if (fn instanceof qx.Promise.Impl) {
        ...
        }
        {
          ...
          fn = function fn(resolve, reject) {
            return origFn(resolve, function (reason) {
              ...
              if (reason === undefined) {
                args.shift();
                args.unshift(qx.Promise.__DEFAULT_ERROR__P_38_2);
        ...
        this.__p__P_38_1 = new qx.Promise.Impl(fn);
      } else {
        this.__p__P_38_1 = new qx.Promise.Impl(this.__externalPromise__P_38_3.bind(this));
      }
      qx.core.Assert.assertTrue(!this.__p__P_38_1.$$qxPromise);
      this.__p__P_38_1.$$qxPromise = this;
      if (context !== undefined && context !== null) {
        this.__p__P_38_1 = this.__p__P_38_1.bind(context);
      }
    },
    /**
     * Destructor
    ...
    members: {
      ...
      bind: function bind(context) {
        return qx.Promise.__wrap__P_38_6(this.__p__P_38_1.bind(context));
      },
      /**
      ...
      cancel: function cancel() {
        {
          ...
          } else if (!qx.Promise.__cancelWarningShown__P_38_5) {
            qx.Promise.__cancelWarningShown__P_38_5 = true;
       ...
       */
      __externalPromise__P_38_3: function __externalPromise__P_38_3(resolve, reject) {
        this.__external__P_38_4 = {
          resolve: resolve,
          reject: reject,
          complete: false
        };
       ...
       */
      __getPendingExternal__P_38_7: function __getPendingExternal__P_38_7() {
        if (!this.__external__P_38_4) {
          throw new Error("Promise cannot be resolved externally");
        }
        if (this.__external__P_38_4.complete) {
          throw new Error("Promise has already been resolved or rejected");
        }
        this.__external__P_38_4.complete = true;
        return this.__external__P_38_4;
      },
      /**
       * Resolves an external promise
       */
      resolve: function resolve(value) {
        this.__getPendingExternal__P_38_7().resolve(value);
      },
      /**
       * Rejects an external promise
       */
      reject: function reject(reason) {
        this.__getPendingExternal__P_38_7().reject(reason);
      },
      /* *********************************************************************************
       *
       * Utility methods
      ...
      _callIterableMethod: function _callIterableMethod(methodName, args) {
        args = qx.Promise.__bindArgs__P_38_8(args);
        return qx.Promise.__wrap__P_38_6(this.__p__P_38_1.then(function (value) {
          var newP = qx.Promise.Impl.resolve(value instanceof qx.data.Array ? value.toArray() : value);
          return qx.Promise.__wrap__P_38_6(newP[methodName].apply(newP, args));
        }));
      },
      /**
      ...
      _callMethod: function _callMethod(methodName, args) {
        args = qx.Promise.__bindArgs__P_38_8(args);
        return qx.Promise.__wrap__P_38_6(this.__p__P_38_1[methodName].apply(this.__p__P_38_1, args));
      },
      /**
    ...
    statics: {
       ...
       */
      __DEFAULT_ERROR__P_38_2: new Error("Default Error"),
      /* *********************************************************************************
       *
       * Promise API methods
       *
      ...
      resolve: function resolve(value, context) {
        ...
        if (value instanceof qx.Promise) {
          ...
          promise = qx.Promise.__wrap__P_38_6(qx.Promise.Impl.resolve(value));
        }
      ...
      reject: function reject(reason, context) {
        ...
        var promise = qx.Promise.__callStaticMethod__P_38_9("reject", args, 0);
        if (context !== undefined) {
          promise = promise.bind(context);
        }
        return promise;
      ...
      all: function all(iterable) {
        return qx.Promise.__callStaticMethod__P_38_9("all", arguments);
      },
      /**
       ...
       */
      race: function race(iterable) {
        return qx.Promise.__callStaticMethod__P_38_9("race", arguments);
      },
      /* *********************************************************************************
       *
       ...
       */
      any: function any(iterable) {
        return qx.Promise.__callStaticMethod__P_38_9("any", arguments);
      },
      /**
       ...
       */
      some: function some(iterable, count) {
        return qx.Promise.__callStaticMethod__P_38_9("some", arguments);
      },
      /**
      ...
      forEach: function forEach(iterable, iterator) {
        return qx.Promise.__callStaticMethod__P_38_9("each", arguments);
      },
      /**
      ...
      filter: function filter(iterable, iterator, options) {
        return qx.Promise.__callStaticMethod__P_38_9("filter", arguments);
      },
      /**
      ...
      map: function map(iterable, iterator, options) {
        return qx.Promise.__callStaticMethod__P_38_9("map", arguments);
      },
      /**
       * Given an <code>Iterable</code>(arrays are <code>Iterable</code>), or a promise of an
       * <code>Iterable</code>, which produces promises (or a mix of promises and values), iterate over
      ...
      mapSeries: function mapSeries(iterable, iterator) {
        return qx.Promise.__callStaticMethod__P_38_9("mapSeries", arguments);
      },
      /**
       * Given an <code>Iterable</code> (arrays are <code>Iterable</code>), or a promise of an
      ...
      reduce: function reduce(iterable, reducer, initialValue) {
        return qx.Promise.__callStaticMethod__P_38_9("reduce", arguments);
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          return qx.Promise.__wrap__P_38_6(wrappedCb.apply(this, arguments));
        };
      },
      /**
      ...
      props: function props(input) {
        return qx.Promise.__callStaticMethod__P_38_9("props", arguments);
      },
      /**
      ...
      __initialized__P_38_10: false,
      /**
       * One-time initializer
       */
      __initialize__P_38_0: function __initialize__P_38_0() {
        if (qx.Promise.__initialized__P_38_10) {
          return;
        }
        qx.Promise.__initialized__P_38_10 = true;
        var isNode = typeof process !== "undefined";
        if (isNode) {
          process.on("unhandledRejection", qx.Promise.__onUnhandledRejection__P_38_11.bind(this));
        } else {
          qx.bom.Event.addNativeListener(window, "unhandledrejection", qx.Promise.__onUnhandledRejection__P_38_11.bind(this));
        }
      },
      /**
       ...
       * @param e {NativeEvent}
       */
      __onUnhandledRejection__P_38_11: function __onUnhandledRejection__P_38_11(e) {
       ...
       * @return {Object}
       */
      __wrap__P_38_6: function __wrap__P_38_6(value) {
       ...
       */
      __bindArgs__P_38_8: function __bindArgs__P_38_8(args, minArgs) {
       ...
       * @return {Object?}
       */
      __callStaticMethod__P_38_9: function __callStaticMethod__P_38_9(methodName, args, minArgs) {
        args = qx.Promise.__bindArgs__P_38_8(args, minArgs);
        return qx.Promise.__wrap__P_38_6(qx.Promise.Impl[methodName].apply(qx.Promise.Impl, qx.Promise.__mapArgs__P_38_12(args)));
      },
      /**
       ...
       */
      __mapArgs__P_38_12: function __mapArgs__P_38_12(args) {
        var dest = [];
...
//# sourceMappingURL=Promise.js.map?dt=1747169150635
  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__styleValues__P_139_0 = styles || null;
      this.__attribValues__P_139_1 = attributes || null;
      this.__slots__P_139_2 = new Map();
      if (attributes) {
    ...
    */
    ...
    statics: {
      ...
      */
      ...
      __selection__P_139_3: {},
      __focusHandler__P_139_4: null,
      __mouseCapture__P_139_5: null,
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _scheduleFlush: function _scheduleFlush(job) {
        qx.html.Element.__deferredCall__P_139_6.schedule();
      },
      /**
      ...
      flush: function flush() {
        ...
        }
        {
          ...
          var focusHandler = this.__getFocusHandler__P_139_7();
          var focusedDomElement = focusHandler.getFocus();
          if (focusedDomElement && this.__willBecomeInvisible__P_139_8(focusedDomElement)) {
            focusHandler.blur(focusedDomElement);
          }

          // deactivate elements, which will be removed
          var activeDomElement = focusHandler.getActive();
          if (activeDomElement && this.__willBecomeInvisible__P_139_8(activeDomElement)) {
            qx.bom.Element.deactivate(activeDomElement);
          }

          // release capture for elements, which will be removed
          var captureDomElement = this.__getCaptureElement__P_139_9();
          if (captureDomElement && this.__willBecomeInvisible__P_139_8(captureDomElement)) {
        ...
        }
        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              // ScrollToX
              if (obj.__lazyScrollX__P_139_10 != null) {
                obj._domNode.scrollLeft = obj.__lazyScrollX__P_139_10;
                delete obj.__lazyScrollX__P_139_10;
              }

              // ScrollToY
              if (obj.__lazyScrollY__P_139_11 != null) {
                obj._domNode.scrollTop = obj.__lazyScrollY__P_139_11;
                delete obj.__lazyScrollY__P_139_11;
              }

              // ScrollIntoViewX
              var intoViewX = obj.__lazyScrollIntoViewX__P_139_12;
              if (intoViewX != null) {
                ...
                if (child && child.offsetWidth) {
                  ...
                  delete obj.__lazyScrollIntoViewX__P_139_12;
                } else {
                  done = false;
                }
              }
        ...
        // Process selection
        for (var hc in this.__selection__P_139_3) {
          var selection = this.__selection__P_139_3[hc];
          var elem = selection.element._domNode;
          if (elem) {
            qx.bom.Selection.set(elem, selection.start, selection.end);
            delete this.__selection__P_139_3[hc];
          }
        }
       ...
       */
      __getFocusHandler__P_139_7: function __getFocusHandler__P_139_7() {
        {
          if (!this.__focusHandler__P_139_4) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__focusHandler__P_139_4 = eventManager.getHandler(qx.event.handler.Focus);
          }
          return this.__focusHandler__P_139_4;
        }
      },
      /**
       ...
       */
      __getCaptureElement__P_139_9: function __getCaptureElement__P_139_9() {
        {
          if (!this.__mouseCapture__P_139_5) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__mouseCapture__P_139_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
          }
          return this.__mouseCapture__P_139_5.getCaptureElement();
        }
      },
      /**
       ...
       */
      __willBecomeInvisible__P_139_8: function __willBecomeInvisible__P_139_8(domElement) {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      __root__P_139_14: false,
      __lazyScrollIntoViewX__P_139_12: null,
      __lazyScrollIntoViewY__P_139_13: null,
      __lazyScrollX__P_139_10: null,
      __lazyScrollY__P_139_11: null,
      __styleJobs__P_139_15: null,
      __attribJobs__P_139_16: null,
      __styleValues__P_139_0: null,
      __attribValues__P_139_1: null,
      /**
      ...
      _serializeImpl: function _serializeImpl(serializer) {
        ...
        // Copy attributes
        if (this.__attribValues__P_139_1) {
          for (var key in this.__attribValues__P_139_1) {
            var result = qx.bom.element.Attribute.serialize(key, this.__attribValues__P_139_1[key]);
        ...
        // Copy styles
        var data = this.__styleValues__P_139_0 || {};
        if (!this.isVisible()) {
      ...
      _addChildImpl: function _addChildImpl(child) {
        ...
        this.__childrenHaveChanged__P_139_17 = true;
      },
      /*
       * @Override
       */
      ...
      */
      ...
      getSlots: function getSlots() {
        ...
        return new Map(this.__slots__P_139_2);
      },
      /**
      ...
      hasSlots: function hasSlots(projection) {
        if (projection === null || projection === undefined) {
          return this.__slots__P_139_2.size > 0;
        }
        if (projection === true || projection === qx.html.Slot.DEFAULT) {
          return this.__slots__P_139_2.has(qx.html.Slot.DEFAULT);
        }
        if (typeof projection === "string") {
          return this.__slots__P_139_2.has(projection);
        }
       ...
       */
      __injectionSlotCheck__P_139_18: function __injectionSlotCheck__P_139_18(slotName) {
        if (!this.hasSlots(slotName)) {
          {
            var what = slotName === qx.html.Slot.DEFAULT ? "default slot" : "slot named \"".concat(slotName, "\"");
            var slotsList = Array.from(this.__slots__P_139_2.keys()).join(", ").replace(qx.html.Slot.DEFAULT, "(default)");
            console.warn("No ".concat(what, " found! Available slots are: ").concat(slotsList));
          }
          return false;
        }
        return true;
      ...
      inject: function inject(childNode, slotNameOverride) {
        ...
        if (!this.__injectionSlotCheck__P_139_18(slotName)) {
          return;
        }
        this.__slots__P_139_2.get(slotName).add(childNode);

        // Chaining support
        return this;
      },
      __slotScan__P_139_19: function __slotScan__P_139_19(element) {
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(function (child) {
          return slots.push.apply(slots, _toConsumableArray(_this.__slotScan__P_139_19(child)));
        });
        return slots;
      },
      _slotScanAdd: function _slotScanAdd(element) {
        var _iterator = _createForOfIteratorHelper(this.__slotScan__P_139_19(element)),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var slot = _step.value;
            this.__slots__P_139_2.set(slot.getName(), slot);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      _slotScanRemove: function _slotScanRemove(child) {
        var _iterator2 = _createForOfIteratorHelper(this.__slotScan__P_139_19(child)),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var slot = _step2.value;
            this.__slots__P_139_2["delete"](slot.getName());
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      */
      ...
      _copyData: function _copyData(fromMarkup, propertiesFromDom) {
        ...
        // Copy attributes
        var data = this.__attribValues__P_139_1;
      ...
      _syncData: function _syncData() {
        ...
        // Sync attributes
        var jobs = this.__attribJobs__P_139_16;
        if (jobs) {
          var data = this.__attribValues__P_139_1;
          if (data) {
            var value;
          ...
          this.__attribJobs__P_139_16 = null;
        }

        // Sync styles
        var jobs = this.__styleJobs__P_139_15;
        if (jobs) {
          var data = this.__styleValues__P_139_0;
          if (data) {
            var styles = {};
          ...
          this.__styleJobs__P_139_15 = null;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setRoot: function setRoot(root) {
        if (root && !this.__root__P_139_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__root__P_139_14) {
          qx.html.Element._hasRoots--;
        }
        this.__root__P_139_14 = root;
      },
      /*
       * @Override
       */
      isRoot: function isRoot() {
        return this.__root__P_139_14;
      },
      /**
      ...
      */
      ...
      scrollChildIntoViewX: function scrollChildIntoViewX(elem, align, direct) {
        ...
        if (direct !== false && thisEl && thisEl.offsetWidth && childEl && childEl.offsetWidth) {
          ...
          this.__lazyScrollIntoViewX__P_139_12 = {
            element: elem,
            align: align
          };
        ...
        delete this.__lazyScrollX__P_139_10;
      },
      /**
       * Scrolls the given child element into view. Only scrolls children.
       * Do not influence elements on top of this element.
      ...
      scrollChildIntoViewY: function scrollChildIntoViewY(elem, align, direct) {
        ...
        if (direct !== false && thisEl && thisEl.offsetWidth && childEl && childEl.offsetWidth) {
          ...
          this.__lazyScrollIntoViewY__P_139_13 = {
            element: elem,
            align: align
          };
          qx.html.Element._scroll[this.toHashCode()] = this;
        ...
        delete this.__lazyScrollY__P_139_11;
      },
      /**
      ...
      scrollToX: function scrollToX(x, lazy) {
        ...
        if (lazy !== true && thisEl && thisEl.offsetWidth) {
          ...
          this.__lazyScrollX__P_139_10 = x;
          qx.html.Element._scroll[this.toHashCode()] = this;
          qx.html.Element._scheduleFlush("element");
        }
        delete this.__lazyScrollIntoViewX__P_139_12;
      },
      /**
      ...
      getScrollX: function getScrollX() {
        ...
        return this.__lazyScrollX__P_139_10 || 0;
      },
      /**
      ...
      scrollToY: function scrollToY(y, lazy) {
        ...
        if (lazy !== true && thisEl && thisEl.offsetWidth) {
          ...
          this.__lazyScrollY__P_139_11 = y;
          qx.html.Element._scroll[this.toHashCode()] = this;
          qx.html.Element._scheduleFlush("element");
        }
        delete this.__lazyScrollIntoViewY__P_139_13;
      },
      /**
      ...
      getScrollY: function getScrollY() {
        ...
        return this.__lazyScrollY__P_139_11 || 0;
      },
      /**
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__onScroll__P_139_20, this);
      },
      /**
       * Re-enables browser-native scrolling
       */
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__onScroll__P_139_20, this);
      },
      __inScroll__P_139_21: null,
      /**
       * Handler for the scroll-event
       *
       * @param e {qx.event.type.Native} scroll-event
       */
      __onScroll__P_139_20: function __onScroll__P_139_20(e) {
        if (!this.__inScroll__P_139_21) {
          this.__inScroll__P_139_21 = true;
          this._domNode.scrollTop = 0;
          this._domNode.scrollLeft = 0;
          delete this.__inScroll__P_139_21;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setTextSelection: function setTextSelection(start, end) {
        ...
        qx.html.Element.__selection__P_139_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function clearTextSelection() {
        ...
        delete qx.html.Element.__selection__P_139_3[this.toHashCode()];
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __performAction__P_139_22: function __performAction__P_139_22(action, args) {
        {
      ...
      focus: function focus() {
        {
          this.__performAction__P_139_22("focus");
        }
      },
      /**
      ...
      blur: function blur() {
        {
          this.__performAction__P_139_22("blur");
        }
      },
      /**
      ...
      activate: function activate() {
        {
          this.__performAction__P_139_22("activate");
        }
      },
      /**
      ...
      deactivate: function deactivate() {
        {
          this.__performAction__P_139_22("deactivate");
        }
      },
      /**
      ...
      capture: function capture(containerCapture) {
        {
          this.__performAction__P_139_22("capture", [containerCapture !== false]);
        }
      },
      /**
      ...
      releaseCapture: function releaseCapture() {
        {
          this.__performAction__P_139_22("releaseCapture");
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        if (!this.__styleValues__P_139_0) {
          this.__styleValues__P_139_0 = {};
        }
        if (this.__styleValues__P_139_0[key] == value) {
          return this;
        }
        this._applyStyle(key, value, this.__styleValues__P_139_0[key]);
        if (value == null) {
          delete this.__styleValues__P_139_0[key];
        } else {
          this.__styleValues__P_139_0[key] = value;
        }
        ...
        if (this._domNode) {
          ...
          if (!this.__styleJobs__P_139_15) {
            this.__styleJobs__P_139_15 = {};
          }

          // Store job info
          this.__styleJobs__P_139_15[key] = true;
      ...
      getStyle: function getStyle(key) {
        return this.__styleValues__P_139_0 ? this.__styleValues__P_139_0[key] : null;
      },
      /**
      ...
      getAllStyles: function getAllStyles() {
        return this.__styleValues__P_139_0 || null;
      },
      /*
      ---------------------------------------------------------------------------
        CSS CLASS SUPPORT
      ---------------------------------------------------------------------------
      */
      __breakClasses__P_139_23: function __breakClasses__P_139_23() {
        var map = {};
      ...
      __combineClasses__P_139_24: function __combineClasses__P_139_24(map) {
      ...
      addClass: function addClass(name) {
        var _this2 = this;
        var classes = this.__breakClasses__P_139_23();
        ...
        this.setAttribute("class", this.__combineClasses__P_139_24(classes));
        return this;
      },
      /**
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        if (!this.__attribValues__P_139_1) {
          this.__attribValues__P_139_1 = {};
        }
        if (this.__attribValues__P_139_1[key] == value) {
          return this;
        }
        if (value == null) {
          delete this.__attribValues__P_139_1[key];
        } else {
          this.__attribValues__P_139_1[key] = value;
        }
        ...
        if (this._domNode) {
          ...
          // Dynamically create if needed
          if (!this.__attribJobs__P_139_16) {
            this.__attribJobs__P_139_16 = {};
          }

          // Store job info
          this.__attribJobs__P_139_16[key] = true;
      ...
      getAttribute: function getAttribute(key) {
        return this.__attribValues__P_139_1 ? this.__attribValues__P_139_1[key] : null;
      }
    },
    /*
     *****************************************************************************
    ...
    defer: function defer(statics) {
      statics.__deferredCall__P_139_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
    *****************************************************************************
       DESTRUCT
    ...
    */
    destruct: function destruct() {
      ...
      this.setRoot(false);
      this.__attribValues__P_139_1 = this.__styleValues__P_139_0 = this.__attribJobs__P_139_16 = this.__styleJobs__P_139_15 = this.__lazyScrollIntoViewX__P_139_12 = this.__lazyScrollIntoViewY__P_139_13 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1747169161407
  ...
  qx.Class.define("qx.html.Node", {
    ...
    members: {
      ...
      */
      ...
      _copyData: function _copyData(fromMarkup, propertiesFromDom) {
        ...
        // Attach events
        var data = this.__eventValues__P_175_0;
        if (data) {
          // Import listeners
          var domEvents = {};
          ...
          delete this.__eventValues__P_175_0;
        }
      ...
      add: function add(varargs) {
        ...
        function addImpl(arr) {
          arr.forEach(function (child) {
            ...
            if (child == null) {
              {
                console.error("Tried to add a child of ".concat(child, " to ").concat(self.classname));
              }
              child = new qx.html.Text("[".concat(child, "]"));
            }
      ...
      */
      ...
      addListener: function addListener(type, listener, self, capture) {
        ...
        var registerDomEvent = function registerDomEvent() {
          ...
          if (!_this2.__eventValues__P_175_0) {
            _this2.__eventValues__P_175_0 = {};
          }
          if (capture == null) {
            capture = false;
          }
          ...
          _this2.__eventValues__P_175_0[id] = {
            type: type,
            listener: listener,
            self: self,
            capture: capture,
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        ...
        if (this._domNode) {
          ...
          var values = this.__eventValues__P_175_0;
          var entry;
          if (capture == null) {
            capture = false;
          }
      ...
      removeListenerById: function removeListenerById(id) {
        ...
        if (id.domEventId) {
          ...
          if (this._domNode) {
            ...
            delete this.__eventValues__P_175_0[id];
          }
        }
        return this;
      },
      ...
      getListeners: function getListeners() {
        ...
        for (var id in this.__eventValues__P_175_0) {
          var listenerData = this.__eventValues__P_175_0[id];
          listeners.push({
    ...
    */
    destruct: function destruct() {
      ...
      this._properties = this._propertyJobs = this._domNode = this._parent = this.__eventValues__P_175_0 = null;
    }
  });
  qx.html.Node.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Node.js.map?dt=1747169164274
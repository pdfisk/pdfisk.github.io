  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Factory", {
    ...
    construct: function construct() {
      ...
      this.__factoriesByTagName__P_207_0 = {};
    ...
    members: {
      __factoriesByTagName__P_207_0: null,
      /**
      ...
      registerFactory: function registerFactory(tagName, factory) {
        ...
        if (this.__factoriesByTagName__P_207_0[tagName] === undefined) {
          this.__factoriesByTagName__P_207_0[tagName] = [];
        }
        this.__factoriesByTagName__P_207_0[tagName].push(factory);
      },
      /**
      ...
      createElement: function createElement(tagName, attributes) {
        ...
        var factories = this.__factoriesByTagName__P_207_0[tagName];
        if (factories) {
...
//# sourceMappingURL=Factory.js.map?dt=1747169166774
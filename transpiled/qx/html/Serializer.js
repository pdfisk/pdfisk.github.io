  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Serializer", {
    ...
    construct: function construct() {
      ...
      this.__output__P_208_0 = "";
      this.__objectStack__P_208_1 = [];
      this.__tagDataStack__P_208_2 = [];
    },
    properties: {
    ...
    members: {
      ...
      __tagDataStack__P_208_2: null,
      /** @type{String?} the current tag name */
      __currentTagName__P_208_3: null,
      /**
      ...
      write: function write() {
        ...
        this.__output__P_208_0 += args.join("");
      },
      /**
      ...
      openTag: function openTag(tagName) {
        this.__flush__P_208_4();
        this.__tagDataStack__P_208_2.push({
          indent: this.__tagDataStack__P_208_2.length,
      ...
      closeTag: function closeTag() {
        this.__flush__P_208_4(true);
        this.__tagDataStack__P_208_2.pop();
      },
      /**
      ...
      setAttribute: function setAttribute(key, value) {
        var tagData = this.__peekTagData__P_208_5();
       ...
       * @returns {TagData}
       */
      __peekTagData__P_208_5: function __peekTagData__P_208_5() {
        return this.__tagDataStack__P_208_2[this.__tagDataStack__P_208_2.length - 1];
      },
      /**
       ...
       */
      __flush__P_208_4: function __flush__P_208_4(closeTag) {
        var _this = this;
        var tagData = this.__peekTagData__P_208_5();
        if (!tagData) {
          return;
        ...
        if (!tagData.openTagWritten) {
          ...
          this.write(tmp.join(" "));
          if (closeTag) {
            if (qx.html.Serializer.__SELF_CLOSING_TAGS__P_208_6[tagData.tagName]) {
              this.write("/>");
            } else {
      ...
      peekQxObject: function peekQxObject() {
        return this.__objectStack__P_208_1[this.__objectStack__P_208_1.length - 1] || null;
      },
      /**
      ...
      getQxObjectIdFor: function getQxObjectIdFor(target) {
        ...
        if (stackTop === target) {
          var secondTop = this.__objectStack__P_208_1.slice(-2)[0] || null;
        ...
        var stackFirst = this.__objectStack__P_208_1[0];
        var tmp = target;
        do {
          var owner = tmp.getQxOwner();
          if (this.__objectStack__P_208_1.indexOf(owner) < 0) {
            break;
    ...
    statics: {
      ...
      __SELF_CLOSING_TAGS__P_208_6: null
    },
    /**
     * Populates statics
     */
    defer: function defer(statics) {
      statics.__SELF_CLOSING_TAGS__P_208_6 = {};
      ["area", "base", "br", "col", "embed", "hr", "img", "input", "link", "meta", "param", "source", "track", "wbr"].forEach(function (tagName) {
        statics.__SELF_CLOSING_TAGS__P_208_6[tagName] = true;
      });
    }
  });
...
//# sourceMappingURL=Serializer.js.map?dt=1747169166828
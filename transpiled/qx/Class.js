  ...
  qx.Bootstrap.define("qx.Class", {
    statics: {
      ...
      */
      ...
      __defineImpl__P_2_1: function __defineImpl__P_2_1(name, config) {
        ...
        if (config.extend) {
          ...
          if (config.objects) {
            this.__addObjects__P_2_8(clazz, config.objects);
          }
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__addMixin__P_2_9(clazz, config.include[i], false);
            }
          }
        }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__addInterface__P_2_10(clazz, config.implement[i]);
          }
        }
        {
          this.__validateAbstractInterfaces__P_2_11(clazz);
        }
      ...
      include: function include(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_2_9(clazz, mixin, false);
      },
      /**
      ...
      patch: function patch(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_2_9(clazz, mixin, true);
      ...
      */
      ...
      __allowedKeys__P_2_12: qx.core.Environment.select("qx.debug", {
        "true": {
          "@": "object",
          "@construct": "object",
          "@destruct": "object",
      ...
      __staticAllowedKeys__P_2_13: qx.core.Environment.select("qx.debug", {
        "true": {
          "@": "object",
          type: "string",
          // String
      ...
      __validateConfig__P_2_2: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          ...
          // Validate keys
          var allowed = config.type === "static" ? this.__staticAllowedKeys__P_2_13 : this.__allowedKeys__P_2_12;
       ...
       */
      __validateAbstractInterfaces__P_2_11: qx.core.Environment.select("qx.debug", {
      ...
      __createClass__P_2_3: function __createClass__P_2_3(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__createDefaultConstructor__P_2_14();
            }
            clazz = this.__wrapConstructor__P_2_15(construct, name, type);
      ...
      */
      ...
      __addObjects__P_2_8: function __addObjects__P_2_8(clazz, objects) {
      ...
      __addProperties__P_2_5: function __addProperties__P_2_5(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          {
            this.__validateProperty__P_2_16(clazz, name, config, patch);
          }
       ...
       */
      __validateProperty__P_2_16: qx.core.Environment.select("qx.debug", {
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          member = members[key];
          {
            if (key.charAt(0) === "@") {
              ...
              if (patch !== true && proto.hasOwnProperty(key) && key != "_createQxObjectImpl") {
       ...
       */
      __addInterface__P_2_10: function __addInterface__P_2_10(clazz, iface) {
        {
          if (!clazz || !iface) {
       ...
       */
      __addMixin__P_2_9: function __addMixin__P_2_9(clazz, mixin, patch) {
        {
          if (!clazz || !mixin) {
            throw new Error("Incomplete parameters!");
          }
      ...
      */
       ...
       */
      __createDefaultConstructor__P_2_14: function __createDefaultConstructor__P_2_14() {
       ...
       */
      __wrapConstructor__P_2_15: function __wrapConstructor__P_2_15(construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1747169145640
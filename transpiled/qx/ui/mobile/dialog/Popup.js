(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.dialog.Popup", {
    ...
    members: {
      __isShown__P_152_1: false,
      __isPlaced__P_152_2: false,
      __childrenContainer__P_152_3: null,
      __percentageTop__P_152_4: null,
      __anchor__P_152_0: null,
      __widget__P_152_5: null,
      __titleWidget__P_152_6: null,
      __lastPopupDimension__P_152_7: null,
      /**
      ...
      _updatePosition: function _updatePosition() {
        ...
        if (this.__anchor__P_152_0) {
          ...
          var anchorPosition = qx.bom.element.Location.get(this.__anchor__P_152_0.getContainerElement());
          var popupDimension = qx.bom.element.Dimension.getSize(this.getContainerElement());
          this.__lastPopupDimension__P_152_7 = popupDimension;
        ...
        } else if (this.__childrenContainer__P_152_3 && !this.__isPlaced__P_152_2) {
       ...
       */
      show: function show() {
        if (!this.__isShown__P_152_1) {
          qx.core.Init.getApplication().fireEvent("popup");
          this.__registerEventListener__P_152_8();
      ...
      hide: function hide() {
        if (this.__isShown__P_152_1) {
          this.__unregisterEventListener__P_152_9();
          this.exclude();
        }
        this.__isShown__P_152_1 = false;
        if (this.getModal()) {
      ...
      isShown: function isShown() {
        return this.__isShown__P_152_1;
      },
      /**
       * Toggles the visibility of this popup.
       */
      toggleVisibility: function toggleVisibility() {
        if (this.__isShown__P_152_1 == true) {
          this.hide();
        } else {
          this.show();
        }
      ...
      _trackUserTap: function _trackUserTap(evt) {
        ...
        var isOutsideWidget = clientX < popupLocation.left || clientX > popupLocation.left + this.__lastPopupDimension__P_152_7.width || clientY > popupLocation.top + this.__lastPopupDimension__P_152_7.height || clientY < popupLocation.top;
        if (isOutsideWidget) {
          this.hide();
        }
      },
       ...
       */
      __registerEventListener__P_152_8: function __registerEventListener__P_152_8() {
        ...
        if (this.__anchor__P_152_0) {
          this.__anchor__P_152_0.addCssClass("anchor-target");
       ...
       */
      __unregisterEventListener__P_152_9: function __unregisterEventListener__P_152_9() {
        ...
        if (this.__anchor__P_152_0) {
          this.__anchor__P_152_0.removeCssClass("anchor-target");
      ...
      _initializeChild: function _initializeChild(widget) {
        if (this.__childrenContainer__P_152_3 == null) {
          this.__childrenContainer__P_152_3 = new qx.ui.mobile.container.Composite(new qx.ui.mobile.layout.VBox());
          this.__childrenContainer__P_152_3.setDefaultCssClass("popup-content");
          this._add(this.__childrenContainer__P_152_3);
        }
        if (this._createTitleWidget()) {
          this.__childrenContainer__P_152_3.remove(this._createTitleWidget());
          this.__childrenContainer__P_152_3.add(this._createTitleWidget());
        }
        this.__childrenContainer__P_152_3.add(widget, {
          flex: 1
        });
        widget.addListener("domupdated", this._updatePosition, this);
        this.__widget__P_152_5 = widget;
      },
      /**
      ...
      _createTitleWidget: function _createTitleWidget() {
        if (this.__titleWidget__P_152_6) {
          return this.__titleWidget__P_152_6;
        }
        if (this.getTitle() || this.getIcon()) {
          this.__titleWidget__P_152_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), this.getIcon());
          this.__titleWidget__P_152_6.addCssClass("popup-title");
          return this.__titleWidget__P_152_6;
        } else {
          return null;
        }
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (value) {
          if (this.__titleWidget__P_152_6) {
            this.__titleWidget__P_152_6.setLabel(value);
          } else {
            this.__titleWidget__P_152_6 = new qx.ui.mobile.basic.Atom(value, this.getIcon());
            this.__titleWidget__P_152_6.addCssClass("popup-title");
            if (this.__widget__P_152_5) {
              this.__childrenContainer__P_152_3.addBefore(this._createTitleWidget(), this.__widget__P_152_5);
            } else {
              if (this.__childrenContainer__P_152_3) {
                this.__childrenContainer__P_152_3.add(this._createTitleWidget());
              }
            }
          }
      ...
      _applyIcon: function _applyIcon(value, old) {
        if (value) {
          if (this.__titleWidget__P_152_6) {
            this.__titleWidget__P_152_6.setIcon(value);
          } else {
            this.__titleWidget__P_152_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), value);
            this.__titleWidget__P_152_6.addCssClass("popup-title");
            if (this.__widget__P_152_5) {
              this.__childrenContainer__P_152_3.addBefore(this._createTitleWidget(), this.__widget__P_152_5);
            } else {
      ...
      removeWidget: function removeWidget() {
        if (this.__widget__P_152_5) {
          this.__widget__P_152_5.removeListener("domupdated", this._updatePosition, this);
          this.__childrenContainer__P_152_3.remove(this.__widget__P_152_5);
          return this.__widget__P_152_5;
        } else {
          {
    ...
    destruct: function destruct() {
      this.__unregisterEventListener__P_152_9();
      this._disposeObjects("__childrenContainer__P_152_3");
      this.__isShown__P_152_1 = this.__isPlaced__P_152_2 = this.__percentageTop__P_152_4 = this._anchor = this.__widget__P_152_5 = this.__lastPopupDimension__P_152_7 = null;
    }
  });
  qx.ui.mobile.dialog.Popup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Popup.js.map?dt=1747169162233
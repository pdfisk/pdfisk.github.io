  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.dialog.Menu", {
    ...
    construct: function construct(itemsModel, anchor) {
      ...
      this.__selectionList__P_109_0 = this._createSelectionList();
      if (itemsModel) {
        this.__selectionList__P_109_0.setModel(itemsModel);
      }
      this.__menuContainer__P_109_1 = new qx.ui.mobile.container.Composite();
      this.__clearButton__P_109_2 = this._createClearButton();
      this.__listScroller__P_109_3 = this._createListScroller(this.__selectionList__P_109_0);
      this.__menuContainer__P_109_1.add(this.__listScroller__P_109_3);
      this.__menuContainer__P_109_1.add(this.__clearButton__P_109_2);
      qx.ui.mobile.dialog.Popup.constructor.call(this, this.__menuContainer__P_109_1, anchor);
      if (anchor) {
        this.setModal(false);
      } else {
        this.setModal(true);
    ...
    */
    ...
    members: {
      __selectionList__P_109_0: null,
      __clearButton__P_109_2: null,
      __listScroller__P_109_3: null,
      __menuContainer__P_109_1: null,
      // overridden
      show: function show() {
      ...
      _createClearButton: function _createClearButton() {
        ...
        clearButton.addListener("tap", this.__onClearButtonTap__P_109_4, this);
        clearButton.exclude();
        return clearButton;
      },
      /**
      ...
      _getListScroller: function _getListScroller() {
        return this.__listScroller__P_109_3;
      },
      // overridden
      _updatePosition: function _updatePosition() {
        ...
        if (this.getVisibleListItems() !== null) {
          var newListScrollerHeight = this.__selectionList__P_109_0.getListItemHeight() * this.getVisibleListItems();
          listScrollerHeight = Math.min(newListScrollerHeight, listScrollerHeight);
        }
        qx.bom.element.Style.set(this.__listScroller__P_109_3.getContainerElement(), "maxHeight", listScrollerHeight + "px");
      ...
      _createSelectionList: function _createSelectionList() {
        ...
        selectionList.addListener("changeSelection", this.__onListChangeSelection__P_109_5, this);
      ...
      getSelectionList: function getSelectionList() {
        return this.__selectionList__P_109_0;
      },
      ...
      setItems: function setItems(itemsModel) {
        if (this.__selectionList__P_109_0) {
          this.__selectionList__P_109_0.setModel(null);
          this.__selectionList__P_109_0.setModel(itemsModel);
        }
      },
      /**
       ...
       */
      __onListChangeSelection__P_109_5: function __onListChangeSelection__P_109_5(evt) {
        this.setSelectedIndex(evt.getData());
      },
      /**
       * Event handler for tap on clear button.
       */
      __onClearButtonTap__P_109_4: function __onClearButtonTap__P_109_4() {
      ...
      _applySelectedIndex: function _applySelectedIndex(value, old) {
        var listModel = this.__selectionList__P_109_0.getModel();
        if (listModel !== null) {
      ...
      _applyNullable: function _applyNullable(value, old) {
        if (value) {
          this.__clearButton__P_109_2.setVisibility("visible");
        } else {
          this.__clearButton__P_109_2.setVisibility("excluded");
        }
      },
      // property apply
      _applyClearButtonLabel: function _applyClearButtonLabel(value, old) {
        this.__clearButton__P_109_2.setValue(value);
      },
      /**
       * Triggers (re-)rendering of menu items.
       */
      _render: function _render() {
        var tmpModel = this.__selectionList__P_109_0.getModel();
        this.__selectionList__P_109_0.setModel(null);
        this.__selectionList__P_109_0.setModel(tmpModel);
      },
      /**
      ...
      scrollToItem: function scrollToItem(index) {
        if (index !== null && this.__selectionList__P_109_0.getModel() != null) {
          var listItems = qxWeb("#" + this.__listScroller__P_109_3.getId() + " .list-item");
          var targetListItemElement = listItems[index];
          this.__listScroller__P_109_3.scrollToElement(targetListItemElement);
        }
      }
    },
    destruct: function destruct() {
      this.__selectionList__P_109_0.removeListener("tap", this._onSelectionListTap, this);
      this._disposeObjects("__selectionList__P_109_0", "__clearButton__P_109_2", "__listScroller__P_109_3", "__menuContainer__P_109_1");
    }
  });
  qx.ui.mobile.dialog.Menu.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Menu.js.map?dt=1747169159502
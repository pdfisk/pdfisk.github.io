  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.List", {
    ...
    construct: function construct(delegate) {
      ...
      this.__provider__P_153_0 = new qx.ui.mobile.list.provider.Provider(this);
      ...
      {
        this.__changeLocaleListListenerId__P_153_1 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    events: {
      /**
    ...
    members: {
      __provider__P_153_0: null,
      __minDeleteDistance__P_153_2: null,
      __isScrollingBlocked__P_153_3: null,
      __trackElement__P_153_4: null,
      // overridden
      ...
      _onTrackStart: function _onTrackStart(evt) {
        this.__isScrollingBlocked__P_153_3 = null;
        this.__trackElement__P_153_4 = null;
        var element = this._getElement(evt);
        if (element && qx.bom.element.Class.has(element, "list-item") && qx.bom.element.Class.has(element, "removable")) {
          this.__trackElement__P_153_4 = element;
          this.__minDeleteDistance__P_153_2 = qx.bom.element.Dimension.getWidth(element) / 2;
      ...
      _onTrack: function _onTrack(evt) {
        if (!this.__trackElement__P_153_4) {
          return;
        }
        var element = this.__trackElement__P_153_4;
        var delta = evt.getDelta();
        var deltaX = Math.round(delta.x * 0.1) / 0.1;
        if (this.__isScrollingBlocked__P_153_3 === null) {
          this.__isScrollingBlocked__P_153_3 = delta.axis == "x";
        }
        if (!this.__isScrollingBlocked__P_153_3) {
          return;
        }
        var opacity = 1 - Math.abs(deltaX) / this.__minDeleteDistance__P_153_2;
      ...
      _onTrackEnd: function _onTrackEnd(evt) {
        ...
        var element = this.__trackElement__P_153_4;
        if (Math.abs(evt.getDelta().x) > this.__minDeleteDistance__P_153_2) {
      ...
      _applyModel: function _applyModel(value, old) {
        if (old != null) {
          old.removeListener("changeBubble", this.__onModelChangeBubble__P_153_5, this);
        }
        if (value != null) {
          value.addListener("changeBubble", this.__onModelChangeBubble__P_153_5, this);
        }
        if (old != null) {
          old.removeListener("change", this.__onModelChange__P_153_6, this);
        }
        if (value != null) {
          value.addListener("change", this.__onModelChange__P_153_6, this);
        }
        if (old != null) {
          old.removeListener("changeLength", this.__onModelChangeLength__P_153_7, this);
        }
        if (value != null) {
          value.addListener("changeLength", this.__onModelChangeLength__P_153_7, this);
        }
        this.__render__P_153_8();
      },
      // property apply
      _applyDelegate: function _applyDelegate(value, old) {
        this.__provider__P_153_0.setDelegate(value);
      },
      /**
       * Listen on model 'changeLength' event.
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __onModelChangeLength__P_153_7: function __onModelChangeLength__P_153_7(evt) {
        this.__render__P_153_8();
      },
      /**
       ...
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __onModelChange__P_153_6: function __onModelChange__P_153_6(evt) {
       ...
       */
      __onModelChangeBubble__P_153_5: function __onModelChangeBubble__P_153_5(evt) {
        if (evt) {
          ...
          if (!isArray || isArray && data.old.length == data.value.length) {
            ...
            for (var i = 0; i < rows.length; i++) {
              this.__renderRow__P_153_9(rows[i]);
            }
          }
        }
      },
       ...
       */
      __renderRow__P_153_9: function __renderRow__P_153_9(index) {
        var renderedItems = qx.bom.Selector.query(".list-item", this.getContentElement());
        var oldNode = renderedItems[index];
        var newNode = this.__provider__P_153_0.getItemElement(this.getModel().getItem(index), index);
      ...
      __render__P_153_8: function __render__P_153_8() {
        ...
        for (var index = 0; index < this.getItemCount(); index++) {
          ...
          var itemElement = this.__provider__P_153_0.getItemElement(item, index);
          var itemHeight = null;
      ...
      _renderGroup: function _renderGroup(itemIndex, groupIndex) {
        var group = this.__getGroup__P_153_11(itemIndex);
        if (itemIndex === 0) {
          return this.__provider__P_153_0.getGroupElement(group, groupIndex);
        } else {
          var previousGroup = this.__getGroup__P_153_11(itemIndex - 1);
       ...
       */
      __hasGroup__P_153_10: function __hasGroup__P_153_10() {
       ...
       */
      __getGroup__P_153_11: function __getGroup__P_153_11(index) {
    ...
    destruct: function destruct() {
      this.__trackElement__P_153_4 = null;
      this._disposeObjects("__provider__P_153_0");
      if (true && this.__changeLocaleListListenerId__P_153_1) {
        qx.locale.Manager.getInstance().removeListenerById(this.__changeLocaleListListenerId__P_153_1);
      }
    }
  });
...
//# sourceMappingURL=List.js.map?dt=1747169162329
  ...
  qx.Class.define("qx.ui.mobile.form.Label", {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.initWrap();
      {
        this.__changeLocaleLabelListenerId__P_70_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    ...
    */
    ...
    members: {
      ...
      setLabelFor: function setLabelFor(elementId) {
        if (this.__forWidget__P_70_1) {
          this.__forWidget__P_70_1.removeListener("changeEnabled", this._changeEnabled, this);
        }
        this.__forWidget__P_70_1 = qx.ui.mobile.core.Widget.getWidgetById(elementId);
        if (this.__forWidget__P_70_1) {
          this.__forWidget__P_70_1.addListener("changeEnabled", this._changeEnabled, this);
          this.setEnabled(this.__forWidget__P_70_1.getEnabled());
        }
      ...
      _onTap: function _onTap(evt) {
        if (this.__forWidget__P_70_1 && qx.core.Environment.get("event.dispatchevent")) {
          var target = this.__forWidget__P_70_1.getContentElement();
    ...
    destruct: function destruct() {
      ...
      if (this.__forWidget__P_70_1) {
        this.__forWidget__P_70_1.removeListener("changeEnabled", this._changeEnabled, this);
        this.__forWidget__P_70_1 = null;
      }
      if (true && this.__changeLocaleLabelListenerId__P_70_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__changeLocaleLabelListenerId__P_70_0);
      }
    }
  });
...
//# sourceMappingURL=Label.js.map?dt=1747169154399
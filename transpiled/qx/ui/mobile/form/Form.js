  ...
  qx.Class.define("qx.ui.mobile.form.Form", {
    ...
    */
    construct: function construct() {
      ...
      this.__invalidItems__P_25_0 = [];
    },
    members: {
      /**
       * the renderer this form uses to be displayed
       */
      __renderer__P_25_1: null,
      /**
       * Contains all invalid items.
       */
      __invalidItems__P_25_0: null,
      /**
      ...
      setRenderer: function setRenderer(renderer) {
        this.__renderer__P_25_1 = renderer;
      },
      /**
      ...
      validate: function validate() {
        ...
        this.__invalidItems__P_25_0 = [];
        if (this.__renderer__P_25_1 != null) {
          this.__renderer__P_25_1.resetForm();
        }
        ...
        for (var i = 0; i < groups.length; i++) {
          ...
          for (var j = 0; j < group.items.length; j++) {
            ...
            if (!item.isValid()) {
              this.__invalidItems__P_25_0.push(item);
              if (this.__renderer__P_25_1 != null) {
                this.__renderer__P_25_1.showErrorForItem(item);
              } else {
        ...
        if (this.__renderer__P_25_1 != null) {
          this.__renderer__P_25_1._domUpdated();
        }
      ...
      showRow: function showRow(groupIndex, rowIndex) {
        ...
        if (item) {
          this.__renderer__P_25_1.showItem(item);
        }
      },
      /**
      ...
      hideRow: function hideRow(groupIndex, rowIndex) {
        var item = this._getItemByIndex(groupIndex, rowIndex);
        if (item) {
          this.__renderer__P_25_1.hideItem(item);
        }
      },
      /**
      ...
      getInvalidItems: function getInvalidItems() {
        return this.__invalidItems__P_25_0;
      }
    }
  });
...
//# sourceMappingURL=Form.js.map?dt=1747169149377
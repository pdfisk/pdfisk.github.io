  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      {
        this.__changeLocaleLabelListenerId__P_194_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      __font__P_194_1: null,
      __invalidContentSize__P_194_2: null,
      __tapListenerId__P_194_3: null,
      __webfontListenerId__P_194_4: null,
      /*
      ---------------------------------------------------------------------------
        WIDGET API
      ---------------------------------------------------------------------------
      */
      ...
      _getContentHint: function _getContentHint() {
        if (this.__invalidContentSize__P_194_2) {
          this.__contentSize__P_194_5 = this.__computeContentSize__P_194_6();
          delete this.__invalidContentSize__P_194_2;
        }
        return {
          width: this.__contentSize__P_194_5.width,
          height: this.__contentSize__P_194_5.height
        };
      },
      // overridden
      ...
      _getContentHeightForWidth: function _getContentHeightForWidth(width) {
        ...
        return this.__computeContentSize__P_194_6(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        var _this = this;
        if (old && this.__font__P_194_1 && this.__webfontListenerId__P_194_4) {
          this.__font__P_194_1.removeListenerById(this.__webfontListenerId__P_194_4);
          this.__webfontListenerId__P_194_4 = null;
        }
        // Apply
        var styles;
        if (value) {
          ...
          this.__font__P_194_1 = value;
          if (this.__font__P_194_1 instanceof qx.bom.webfonts.WebFont && !this.__font__P_194_1.isValid()) {
            this.__webfontListenerId__P_194_4 = this.__font__P_194_1.addListener("changeStatus", function (evt) {
              if (evt.getData().valid) {
                _this.__invalidContentSize__P_194_2 = true;
                qx.ui.core.queue.Layout.add(_this);
              }
            });
          }
          styles = this.__font__P_194_1.getStyles();
        } else {
          this.__font__P_194_1 = null;
        ...
        this.__invalidContentSize__P_194_2 = true;
       ...
       */
      __computeContentSize__P_194_6: function __computeContentSize__P_194_6(width) {
        var Label = qx.bom.Label;
        var font = this.getFont();
        var styles = font ? this.__font__P_194_1.getStyles() : qx.bom.Font.getDefaultStyles();
        var content = this.getValue() || "A";
        var rich = this.getRich();
        if (this.__webfontListenerId__P_194_4) {
          this.__fixEllipsis__P_194_7();
        }
       ...
       */
      __fixEllipsis__P_194_7: function __fixEllipsis__P_194_7() {
      ...
      */
      ...
      _applyBuddy: function _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__tapListenerId__P_194_3);
          this.__tapListenerId__P_194_3 = null;
        }
        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__tapListenerId__P_194_3 = this.addListener("tap", function () {
    ...
    */
    destruct: function destruct() {
      if (true && this.__changeLocaleLabelListenerId__P_194_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__changeLocaleLabelListenerId__P_194_0);
      }
      if (this.__font__P_194_1 && this.__webfontListenerId__P_194_4) {
        this.__font__P_194_1.removeListenerById(this.__webfontListenerId__P_194_4);
      }
      this.__font__P_194_1 = null;
    }
...
//# sourceMappingURL=Label.js.map?dt=1747169165798
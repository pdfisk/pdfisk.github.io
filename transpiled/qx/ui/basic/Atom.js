  ...
  qx.Class.define("qx.ui.basic.Atom", {
    ...
    */
    ...
    members: {
      ...
      __safeSetPropertyOnLayout__P_164_0: function __safeSetPropertyOnLayout__P_164_0(value, propertyName) {
        ...
        if (layout[propertySetter]) {
          ...
          this.warn("The `".concat(propertyName, "` property of a ").concat(this.classname, " was set, but the layout ").concat(this._getLayout().classname, " does not support a `").concat(propertyName, "` property."));
        }
      },
      // property apply
      _applyGap: function _applyGap(value) {
        this.__safeSetPropertyOnLayout__P_164_0(value, "gap");
      },
      // property apply
      _applyIconPosition: function _applyIconPosition(value) {
        this.__safeSetPropertyOnLayout__P_164_0(value, "iconPosition");
      },
      // property apply
      _applyCenter: function _applyCenter(value) {
        this.__safeSetPropertyOnLayout__P_164_0(value, "center");
      },
      // overridden
...
//# sourceMappingURL=Atom.js.map?dt=1747169163283
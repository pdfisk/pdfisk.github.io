  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__modelSelection__P_184_0 = new qx.data.Array();

      // listen to the changes
      this.__modelSelection__P_184_0.addListener("change", this.__onModelSelectionArrayChange__P_184_1, this);
      this.addListener("changeSelection", this.__onModelSelectionChange__P_184_2, this);
    },
    events: {
      /**
    ...
    members: {
      __modelSelection__P_184_0: null,
      __inSelectionChange__P_184_3: false,
      /**
       * Handler for the selection change of the including class e.g. SelectBox,
       * List, ...
       * It sets the new modelSelection via {@link #setModelSelection}.
       */
      __onModelSelectionChange__P_184_2: function __onModelSelectionChange__P_184_2() {
        if (this.__inSelectionChange__P_184_3) {
          return;
        }
       ...
       */
      __onModelSelectionArrayChange__P_184_1: function __onModelSelectionArrayChange__P_184_1() {
        this.__inSelectionChange__P_184_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];
        var modelSelection = this.__modelSelection__P_184_0.toArray();
        ...
        this.__inSelectionChange__P_184_3 = false;
        ...
        if (!qx.lang.Array.equals(currentSelection, itemSelection)) {
          ...
          this.__onModelSelectionChange__P_184_2();
        }
      },
      /**
      ...
      getModelSelection: function getModelSelection() {
        return this.__modelSelection__P_184_0;
      },
      /**
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__modelSelection__P_184_0.removeAll();
          return;
        }
        {
        ...
        modelSelection.unshift(this.__modelSelection__P_184_0.getLength()); // remove index
        modelSelection.unshift(0); // start index

        var returnArray = this.__modelSelection__P_184_0.splice.apply(this.__modelSelection__P_184_0, modelSelection);
        returnArray.dispose();
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__modelSelection__P_184_0");
    }
  });
  qx.ui.form.MModelSelection.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MModelSelection.js.map?dt=1747169165072
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.Resetter", {
    ...
    construct: function construct() {
      ...
      this.__items__P_108_0 = [];
    },
    members: {
      __items__P_108_0: null,
      /**
      ...
      add: function add(field) {
        this.__typeCheck__P_108_1(field);
        this.__items__P_108_0.push({
          item: field,
          init: field.getValue()
        });
      },
      ...
      remove: function remove(field) {
        this.__typeCheck__P_108_1(field);
        for (var i = 0; i < this.__items__P_108_0.length; i++) {
          var storedItem = this.__items__P_108_0[i];
          if (storedItem.item === field) {
            this.__items__P_108_0.splice(i, 1);
            return true;
          }
        }
        return false;
      ...
      reset: function reset() {
        var dataEntry,
          ...
          errors = [];
        for (var i = 0; i < this.__items__P_108_0.length; i++) {
          dataEntry = this.__items__P_108_0[i];
      ...
      resetItem: function resetItem(field) {
        this.__typeCheck__P_108_1(field);
        for (var i = 0; i < this.__items__P_108_0.length; i++) {
          var dataEntry = this.__items__P_108_0[i];
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__items__P_108_0.length; i++) {
          var item = this.__items__P_108_0[i].item;
          // set the new init value for the item
          this.__items__P_108_0[i].init = item.getValue();
        }
      },
      /**
      ...
      redefineItem: function redefineItem(field) {
        ...
        var dataEntry;
        for (var i = 0; i < this.__items__P_108_0.length; i++) {
          if (this.__items__P_108_0[i].item === field) {
            dataEntry = this.__items__P_108_0[i];
       ...
       * @private
       */
      __typeCheck__P_108_1: function __typeCheck__P_108_1(field) {
    ...
    */
    destruct: function destruct() {
      ...
      this.__items__P_108_0 = null;
    }
  });
  qx.ui.form.Resetter.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resetter.js.map?dt=1747169159404
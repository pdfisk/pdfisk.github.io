  ...
  qx.Class.define("qx.ui.menu.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Create open timer
      this.__openTimer__P_170_1 = new qx.event.Timer();
      this.__openTimer__P_170_1.addListener("interval", this._onOpenInterval, this);

      // Create close timer
      this.__closeTimer__P_170_2 = new qx.event.Timer();
      this.__closeTimer__P_170_2.addListener("interval", this._onCloseInterval, this);
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
      __scheduleOpen__P_170_3: null,
      __scheduleClose__P_170_4: null,
      __openTimer__P_170_1: null,
      __closeTimer__P_170_2: null,
      __objects__P_170_0: null,
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ---------------------------------------------------------------------------
      */
      ...
      _isMenuOpener: function _isMenuOpener(widget) {
        var menus = this.__objects__P_170_0;
      ...
      */
      ...
      add: function add(obj) {
        ...
        var reg = this.__objects__P_170_0;
        reg.push(obj);
      ...
      */
      ...
      scheduleOpen: function scheduleOpen(menu) {
        ...
        if (menu.isVisible()) {
          ...
          if (this.__scheduleOpen__P_170_3) {
            this.cancelOpen(this.__scheduleOpen__P_170_3);
          }
        }

        // When the menu is not visible and not scheduled already
        // then schedule it for opening
        else if (this.__scheduleOpen__P_170_3 != menu) {
          // menu.debug("Schedule open");
          this.__scheduleOpen__P_170_3 = menu;
          this.__openTimer__P_170_1.restartWith(menu.getOpenInterval());
        }
      },
      /**
      ...
      scheduleClose: function scheduleClose(menu) {
        ...
        if (!menu.isVisible()) {
          ...
          if (this.__scheduleClose__P_170_4) {
            this.cancelClose(this.__scheduleClose__P_170_4);
          }
        }

        // When the menu is visible and not scheduled already
        // then schedule it for closing
        else if (this.__scheduleClose__P_170_4 != menu) {
          // menu.debug("Schedule close");
          this.__scheduleClose__P_170_4 = menu;
          this.__closeTimer__P_170_2.restartWith(menu.getCloseInterval());
        }
      },
      /**
      ...
      cancelOpen: function cancelOpen(menu) {
        if (this.__scheduleOpen__P_170_3 == menu) {
          // menu.debug("Cancel open");
          this.__openTimer__P_170_1.stop();
          this.__scheduleOpen__P_170_3 = null;
        }
      },
      /**
      ...
      cancelClose: function cancelClose(menu) {
        if (this.__scheduleClose__P_170_4 == menu) {
          // menu.debug("Cancel close");
          this.__closeTimer__P_170_2.stop();
          this.__scheduleClose__P_170_4 = null;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onOpenInterval: function _onOpenInterval(e) {
        ...
        this.__scheduleOpen__P_170_3.open();
        this.__scheduleOpen__P_170_3 = null;
      },
      /**
      ...
      _onCloseInterval: function _onCloseInterval(e) {
        ...
        this.__scheduleClose__P_170_4.exclude();
        this.__scheduleClose__P_170_4 = null;
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      preventContextMenuOnce: function preventContextMenuOnce() {
        qx.event.Registration.addListener(document.body, "contextmenu", this.__onPreventContextMenu__P_170_5, this, true);
      },
      /**
       ...
       * @internal
       */
      __onPreventContextMenu__P_170_5: function __onPreventContextMenu__P_170_5(e) {
        ...
        // stop only once
        qx.event.Registration.removeListener(document.body, "contextmenu", this.__onPreventContextMenu__P_170_5, this, true);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__objects__P_170_0.length > 0 && !this._isInMenu(target)) {
          this.hideAll();
        }
      },
      /*
      ...
      */
      ...
      _onKeyUpDown: function _onKeyUpDown(e) {
        ...
        if (this.__navigationKeys__P_170_7[iden] || this.__selectionKeys__P_170_6[iden] && menu.getSelectedButton()) {
          e.stopPropagation();
        }
      },
      /**
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        var iden = e.getKeyIdentifier();
        var navigation = this.__navigationKeys__P_170_7[iden];
        var selection = this.__selectionKeys__P_170_6[iden];
        if (navigation) {
          switch (iden) {
            case "Up":
      ...
      _onRoll: function _onRoll(e) {
        var target = e.getTarget();
        target = qx.ui.core.Widget.getWidgetByElement(target, true);
        if (this.__objects__P_170_0.length > 0 && !this._isInMenu(target) && !this._isMenuOpener(target) && !e.getMomentum()) {
          this.hideAll();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__openTimer__P_170_1", "__closeTimer__P_170_2");
      this._disposeArray("__objects__P_170_0");
    }
  });
  qx.ui.menu.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1747169163811
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.menu.Menu", {
    ...
    */
    ...
    members: {
      __scheduledOpen__P_133_0: null,
      __onAfterSlideBarAdd__P_133_1: null,
      ...
      */
      ...
      open: function open() {
        if (this.getOpener() != null) {
          ...
          if (isPlaced) {
            this.__updateSlideBar__P_133_2();
            this.show();
      ...
      */
      ...
      _applyVisibility: function _applyVisibility(value, old) {
        ...
        this.__updateBlockerVisibility__P_133_3();
      },
      /**
       * Updates the blocker's visibility
       */
      __updateBlockerVisibility__P_133_3: function __updateBlockerVisibility__P_133_3() {
        if (this.isVisible()) {
      ...
      _applySelectedButton: function _applySelectedButton(value, old) {
        ...
        // ARIA attrs
        var opener = this.__getRootOpener__P_133_4();
      ...
      */
       ...
       * and position.
       */
      __updateSlideBar__P_133_2: function __updateSlideBar__P_133_2() {
        var menuBounds = this._getMenuBounds();
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__updateSlideBar__P_133_2, this);
          return;
        }
      ...
      _assertSlideBar: function _assertSlideBar(callback) {
        ...
        this.__onAfterSlideBarAdd__P_133_1 = callback;
        qx.ui.core.queue.Widget.add(this);
      },
      // overridden
      syncWidget: function syncWidget(jobs) {
        this.getChildControl("slidebar");
        if (this.__onAfterSlideBarAdd__P_133_1) {
          this.__onAfterSlideBarAdd__P_133_1.call(this);
          delete this.__onAfterSlideBarAdd__P_133_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      _onPointerOver: function _onPointerOver(e) {
        ...
        if (target.isEnabled() && target instanceof qx.ui.menu.AbstractButton) {
          ...
          if (subMenu) {
            ...
            this.__scheduledOpen__P_133_0 = subMenu;
          } else {
            var opened = this.getOpenedButton();
            if (opened) {
              mgr.scheduleClose(opened.getMenu());
            }
            if (this.__scheduledOpen__P_133_0) {
              mgr.cancelOpen(this.__scheduledOpen__P_133_0);
              this.__scheduledOpen__P_133_0 = null;
            }
          }
      ...
      */
       ...
       */
      __getRootOpener__P_133_4: function __getRootOpener__P_133_4() {
        var parentMenu = this.getParentMenu();
        if (!parentMenu) {
...
//# sourceMappingURL=Menu.js.map?dt=1747169160912
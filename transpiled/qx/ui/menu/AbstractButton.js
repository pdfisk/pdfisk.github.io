  ...
  qx.Class.define("qx.ui.menu.AbstractButton", {
    ...
    */
      ...
      */
      ...
      _onChangeCommand: function _onChangeCommand(e) {
        ...
        }
        {
          ...
          if (!oldCommand) {
            this.__changeLocaleCommandListenerId__P_171_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
          }
          if (!command && this.__changeLocaleCommandListenerId__P_171_0) {
            qx.locale.Manager.getInstance().removeListenerById(this.__changeLocaleCommandListenerId__P_171_0);
          }
        }
    ...
    destruct: function destruct() {
      ...
      if (true && this.__changeLocaleCommandListenerId__P_171_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__changeLocaleCommandListenerId__P_171_0);
      }
    }
  });
...
//# sourceMappingURL=AbstractButton.js.map?dt=1747169163872
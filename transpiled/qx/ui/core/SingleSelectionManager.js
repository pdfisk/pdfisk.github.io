  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct: function construct(selectionProvider) {
      ...
      this.__selectionProvider__P_209_0 = selectionProvider;
    },
    /*
    *****************************************************************************
       EVENTS
    ...
    */
    ...
    properties: {
      ...
      allowEmptySelection: {
        check: "Boolean",
        init: true,
        apply: "__applyAllowEmptySelection__P_209_1"
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      */
      ...
      getSelected: function getSelected() {
        return this.__selected__P_209_2;
      },
      /**
      ...
      resetSelected: function resetSelected() {
        this.__setSelected__P_209_4(null);
      },
      /**
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__selected__P_209_2 === item;
      },
      /**
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__selected__P_209_2 == null;
      },
      /**
      ...
      getSelectables: function getSelectables(all) {
        var items = this.__selectionProvider__P_209_0.getItems();
        var result = [];
        for (var i = 0; i < items.length; i++) {
          if (this.__selectionProvider__P_209_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
        }
      ...
      */
      // apply method
      __applyAllowEmptySelection__P_209_1: function __applyAllowEmptySelection__P_209_1(value, old) {
        if (!value) {
          this.__setSelected__P_209_4(this.__selected__P_209_2);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __setSelected__P_209_4: function __setSelected__P_209_4(item) {
        var oldSelected = this.__selected__P_209_2;
        ...
        this.__selected__P_209_2 = newSelected;
       ...
       *    <code>false</code> otherwise.
       */
      __isChildElement__P_209_3: function __isChildElement__P_209_3(item) {
        var items = this.__selectionProvider__P_209_0.getItems();
        for (var i = 0; i < items.length; i++) {
          if (items[i] === item) {
            return true;
    ...
    destruct: function destruct() {
      if (this.__selectionProvider__P_209_0.toHashCode) {
        this._disposeObjects("__selectionProvider__P_209_0");
      } else {
        this.__selectionProvider__P_209_0 = null;
      }
      this._disposeObjects("__selected__P_209_2");
    }
  });
  qx.ui.core.SingleSelectionManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SingleSelectionManager.js.map?dt=1747169166959
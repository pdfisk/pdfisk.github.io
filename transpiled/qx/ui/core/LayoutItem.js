  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    construct: function construct() {
      ...
      {
        this.__changeThemeLayoutItemListenerId__P_132_0 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      getBounds: function getBounds() {
        return this.__userBounds__P_132_6 || this.__computedLayout__P_132_2 || null;
      },
      /**
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        var computed = this.__computedLayout__P_132_2;
        if (!computed) {
          computed = this.__computedLayout__P_132_2 = {};
        }
        ...
        if (this.__hasInvalidLayout__P_132_3) {
          changes.local = true;
          delete this.__hasInvalidLayout__P_132_3;
        }
        if (this.__updateMargin__P_132_5) {
          changes.margin = true;
          delete this.__updateMargin__P_132_5;
        }
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__computedHeightForWidth__P_132_1) {
            // This variable is used in the next computation of the size hint
            this.__computedHeightForWidth__P_132_1 = flowHeight;
      ...
      hasValidLayout: function hasValidLayout() {
        return !this.__hasInvalidLayout__P_132_3;
      },
      /**
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        this.__hasInvalidLayout__P_132_3 = true;
        this.__sizeHint__P_132_4 = null;
      },
      /**
      ...
      getSizeHint: function getSizeHint(compute) {
        var hint = this.__sizeHint__P_132_4;
        if (hint) {
          return hint;
        }
        if (compute === false) {
        ...
        // Compute as defined
        hint = this.__sizeHint__P_132_4 = this._computeSizeHint();

        // Respect height for width
        if (this._hasHeightForWidth() && this.__computedHeightForWidth__P_132_1 && this.getHeight() == null) {
          hint.height = this.__computedHeightForWidth__P_132_1;
        }
      ...
      _applyMargin: function _applyMargin() {
        this.__updateMargin__P_132_5 = true;
      ...
      */
      ...
      hasUserBounds: function hasUserBounds() {
        return !!this.__userBounds__P_132_6;
      },
      /**
      ...
      setUserBounds: function setUserBounds(left, top, width, height) {
        if (!this.__userBounds__P_132_6) {
          var parent = this.$$parent;
          if (parent) {
            parent.updateLayoutProperties();
          }
        }
        this.__userBounds__P_132_6 = {
          left: left,
          top: top,
          width: width,
          height: height
      ...
      resetUserBounds: function resetUserBounds() {
        if (this.__userBounds__P_132_6) {
          delete this.__userBounds__P_132_6;
          var parent = this.$$parent;
          if (parent) {
            parent.updateLayoutProperties();
          }
      ...
      */
      ...
      setLayoutProperties: function setLayoutProperties(props) {
        ...
        var storage = this.__layoutProperties__P_132_7;
        if (!storage) {
          storage = this.__layoutProperties__P_132_7 = {};
        }
      ...
      getLayoutProperties: function getLayoutProperties() {
        return this.__layoutProperties__P_132_7 || this.__emptyProperties__P_132_8;
      },
      /**
      ...
      clearLayoutProperties: function clearLayoutProperties() {
        delete this.__layoutProperties__P_132_7;
      },
      /**
      ...
      */
      ...
      clone: function clone() {
        ...
        var props = this.__layoutProperties__P_132_7;
        if (props) {
          clone.__layoutProperties__P_132_7 = qx.lang.Object.clone(props);
        }
        return clone;
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__changeThemeLayoutItemListenerId__P_132_0) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__changeThemeLayoutItemListenerId__P_132_0);
      }
      this.$$parent = this.$$subparent = this.__layoutProperties__P_132_7 = this.__computedLayout__P_132_2 = this.__userBounds__P_132_6 = this.__sizeHint__P_132_4 = null;
    }
  });
  qx.ui.core.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1747169160783
  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    */
    construct: function construct() {
      ...
      this.__contentElement__P_95_0 = this.__createContentElement__P_95_1();
    ...
    */
    ...
    statics: {
      ...
      __separatorPool__P_95_2: new qx.util.ObjectPool()
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
      __contentElement__P_95_0: null,
      __initialAppearanceApplied__P_95_3: null,
      __toolTipTextListenerId__P_95_4: null,
      /*
      ---------------------------------------------------------------------------
        LAYOUT INTERFACE
      ---------------------------------------------------------------------------
      */
       ...
       */
      __layoutManager__P_95_5: null,
      // overridden
      _getLayout: function _getLayout() {
        return this.__layoutManager__P_95_5;
      },
      /**
      ...
      _setLayout: function _setLayout(layout) {
        ...
        if (this.__layoutManager__P_95_5) {
          this.__layoutManager__P_95_5.connectToWidget(null);
        }
        if (layout) {
          layout.connectToWidget(this);
        }
        this.__layoutManager__P_95_5 = layout;
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (inner || changes.local || changes.margin) {
          if (this.__layoutManager__P_95_5 && this.hasLayoutChildren()) {
            ...
            this.__layoutManager__P_95_5.renderLayout(innerWidth, innerHeight, padding);
      ...
      */
      ...
      __separators__P_95_6: null,
      // overridden
      clearSeparators: function clearSeparators() {
        var reg = this.__separators__P_95_6;
        if (!reg) {
          return;
        }
        var pool = qx.ui.core.Widget.__separatorPool__P_95_2;
        var content = this.getContentElement();
        var widget;
      ...
      renderSeparator: function renderSeparator(separator, bounds) {
        // Insert
        var widget = qx.ui.core.Widget.__separatorPool__P_95_2.getObject(qx.ui.core.Widget);
        widget.set({
          decorator: separator
        });
        ...
        // Remember element
        if (!this.__separators__P_95_6) {
          this.__separators__P_95_6 = [];
        }
        this.__separators__P_95_6.push(widget);
      },
      /*
      ---------------------------------------------------------------------------
        SIZE HINTS
      ...
      */
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        if (this.__layoutManager__P_95_5) {
          this.__layoutManager__P_95_5.invalidateLayoutCache();
        }
      },
      /**
      ...
      _getContentHint: function _getContentHint() {
        var layout = this.__layoutManager__P_95_5;
        if (layout) {
      ...
      */
       ...
       */
      __createContentElement__P_95_1: function __createContentElement__P_95_1() {
      ...
      getContentElement: function getContentElement() {
        return this.__contentElement__P_95_0;
      },
      /*
      ---------------------------------------------------------------------------
        CHILDREN HANDLING
      ...
      */
      ...
      getLayoutChildren: function getLayoutChildren() {
        var children = this.__widgetChildren__P_95_7;
        if (!children) {
          return this.__emptyChildren__P_95_8;
        }
        var layoutChildren;
      ...
      _getChildren: function _getChildren() {
        return this.__widgetChildren__P_95_7 || this.__emptyChildren__P_95_8;
      },
      /**
      ...
      _add: function _add(child, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__widgetChildren__P_95_7, child);
        }
        if (this.__widgetChildren__P_95_7) {
          this.__widgetChildren__P_95_7.push(child);
        } else {
          this.__widgetChildren__P_95_7 = [child];
        }
        this.__addHelper__P_95_9(child, options);
      },
      /**
      ...
      _addAt: function _addAt(child, index, options) {
        ...
        var ref = this.__widgetChildren__P_95_7[index];
        if (ref === child) {
          child.setLayoutProperties(options);
        }
        if (ref) {
          qx.lang.Array.insertBefore(this.__widgetChildren__P_95_7, child, ref);
        } else {
          this.__widgetChildren__P_95_7.push(child);
        }
        this.__addHelper__P_95_9(child, options);
      ...
      _addBefore: function _addBefore(child, before, options) {
        ...
        qx.lang.Array.insertBefore(this.__widgetChildren__P_95_7, child, before);
        this.__addHelper__P_95_9(child, options);
      },
      /**
      ...
      _addAfter: function _addAfter(child, after, options) {
        ...
        qx.lang.Array.insertAfter(this.__widgetChildren__P_95_7, child, after);
        this.__addHelper__P_95_9(child, options);
      },
      /**
      ...
      _remove: function _remove(child) {
        ...
        qx.lang.Array.remove(this.__widgetChildren__P_95_7, child);
        this.__removeHelper__P_95_10(child);
      },
      /**
      ...
      _removeAt: function _removeAt(index) {
        ...
        var child = this.__widgetChildren__P_95_7[index];
        qx.lang.Array.removeAt(this.__widgetChildren__P_95_7, index);
        this.__removeHelper__P_95_10(child);
        return child;
      },
      /**
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__widgetChildren__P_95_7.concat();
        this.__widgetChildren__P_95_7.length = 0;
        for (var i = children.length - 1; i >= 0; i--) {
          this.__removeHelper__P_95_10(children[i]);
        }
        qx.ui.core.queue.Layout.add(this);
        return children;
      },
      ...
      */
       ...
       */
      __addHelper__P_95_9: function __addHelper__P_95_9(child, options) {
        {
       ...
       */
      __removeHelper__P_95_10: function __removeHelper__P_95_10(child) {
        {
        ...
        if (this.__layoutManager__P_95_5) {
          this.__layoutManager__P_95_5.invalidateChildrenCache();
        }
      ...
      */
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        qx.ui.core.queue.Layout.add(this);
        this.__updateContentPadding__P_95_11(name, value);
      },
      /**
       ...
       */
      __updateContentPadding__P_95_11: function __updateContentPadding__P_95_11(style, value) {
        var content = this.getContentElement();
        var decorator = this.getDecorator();
        decorator = qx.theme.manager.Decoration.getInstance().resolve(decorator);
        if (decorator) {
      ...
      */
      ...
      _applyToolTipText: function _applyToolTipText(value, old) {
        var _this = this;
        {
          if (this.__toolTipTextListenerId__P_95_4) {
            return;
          }
          var manager = qx.locale.Manager.getInstance();
          this.__toolTipTextListenerId__P_95_4 = manager.addListener("changeLocale", function () {
      ...
      */
      ...
      hasState: function hasState(state) {
        var states = this.__states__P_95_12;
      ...
      addState: function addState(state) {
        ...
        // Add state and queue
        this.__states__P_95_12[state] = true;
        ...
        var controls = this.__childControls__P_95_13;
      ...
      removeState: function removeState(state) {
        ...
        delete this.__states__P_95_12[state];
      ...
      */
      ...
      syncAppearance: function syncAppearance() {
        var states = this.__states__P_95_12;
        var selector = this.__appearanceSelector__P_95_14;
        ...
        if (this.__updateSelector__P_95_15) {
          // Clear flag
          delete this.__updateSelector__P_95_15;
        ...
        if (!selector) {
          ...
          this.__appearanceSelector__P_95_14 = selector;
        }
        ...
        this.fireDataEvent("syncAppearance", this.__states__P_95_12);
      },
      // property apply
      ...
      checkAppearanceNeeds: function checkAppearanceNeeds() {
        ...
        if (!this.__initialAppearanceApplied__P_95_3) {
          qx.ui.core.queue.Appearance.add(this);
          this.__initialAppearanceApplied__P_95_3 = true;
        }
      ...
      updateAppearance: function updateAppearance() {
        // Clear selector
        this.__updateSelector__P_95_15 = true;
      ...
      */
      ...
      hasChildControl: function hasChildControl(id) {
        if (!this.__childControls__P_95_13) {
          return false;
        }
        return !!this.__childControls__P_95_13[id];
      },
      /** @type {Map} Map of instantiated child controls */
      __childControls__P_95_13: null,
      /**
      ...
      _getCreatedChildControls: function _getCreatedChildControls() {
        return this.__childControls__P_95_13;
      },
      /**
      ...
      getChildControl: function getChildControl(id, notcreate) {
        if (!this.__childControls__P_95_13) {
          ...
          this.__childControls__P_95_13 = {};
        }
        var control = this.__childControls__P_95_13[id];
        if (control) {
          return control;
        }
        if (notcreate === true) {
      ...
      _releaseChildControl: function _releaseChildControl(id) {
        ...
        delete this.__childControls__P_95_13[id];
        return control;
      },
      /**
      ...
      _createChildControl: function _createChildControl(id) {
        if (!this.__childControls__P_95_13) {
          this.__childControls__P_95_13 = {};
        } else if (this.__childControls__P_95_13[id]) {
        ...
        return this.__childControls__P_95_13[id] = control;
      },
      /**
      ...
      _disposeChildControls: function _disposeChildControls() {
        ...
        delete this.__childControls__P_95_13;
      },
      /**
      ...
      */
      ...
      addAriaLabelledBy: function addAriaLabelledBy() {
        ...
        this.__addAriaXBy__P_95_16(labelWidgets, "aria-labelledby");
      },
      /**
      ...
      addAriaDescribedBy: function addAriaDescribedBy() {
        ...
        this.__addAriaXBy__P_95_16(describingWidgets, "aria-describedby");
      },
      /**
       ...
       */
      __addAriaXBy__P_95_16: function __addAriaXBy__P_95_16(widgets, ariaAttr) {
    ...
    */
    destruct: function destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        {
          if (this.__toolTipTextListenerId__P_95_4) {
            qx.locale.Manager.getInstance().removeListenerById(this.__toolTipTextListenerId__P_95_4);
          }
        }
      ...
      if (!qx.core.ObjectRegistry.inShutDown) {
        ...
        this.__separators__P_95_6 = null;
      } else {
        this._disposeArray("__separators__P_95_6");
      }

      // Clear children array
      this._disposeArray("__widgetChildren__P_95_7");

      // Cleanup map of appearance states
      this.__states__P_95_12 = this.__childControls__P_95_13 = null;

      // Dispose layout manager and HTML elements
      this._disposeObjects("__layoutManager__P_95_5", "__contentElement__P_95_0");
    }
  });
  qx.ui.core.Widget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Widget.js.map?dt=1747169158095
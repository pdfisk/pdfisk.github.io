  ...
  qx.Class.define("qx.ui.core.queue.Widget", {
    statics: {
      ...
      remove: function remove(widget, job) {
        var queue = this.__queue__P_144_0;
        ...
        if (job == null) {
          ...
          delete this.__jobs__P_144_1[hash];
          return;
        }
        if (this.__jobs__P_144_1[hash]) {
          delete this.__jobs__P_144_1[hash][job];
          if (qx.lang.Object.getLength(this.__jobs__P_144_1[hash]) == 0) {
            qx.lang.Array.remove(queue, widget);
          }
        }
      },
      ...
      add: function add(widget, job) {
        ...
        var hash = widget.toHashCode();
        if (!this.__jobs__P_144_1[hash]) {
          this.__jobs__P_144_1[hash] = {};
        }
        this.__jobs__P_144_1[hash][job] = true;
      ...
      flush: function flush() {
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          obj = queue[i];
          jobs = this.__jobs__P_144_1[obj.toHashCode()];
          queue.splice(i, 1);
          obj.syncWidget(jobs);
        }
        ...
        this.__queue__P_144_0 = [];
        this.__jobs__P_144_1 = {};
      }
    }
  });
...
//# sourceMappingURL=Widget.js.map?dt=1747169161598
  ...
  qx.Class.define("qx.ui.core.queue.Appearance", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__lookup__P_141_1[widget.toHashCode()]) {
          qx.lang.Array.remove(this.__queue__P_141_0, widget);
          delete this.__lookup__P_141_1[widget.toHashCode()];
        }
      },
      /**
      ...
      add: function add(widget) {
        ...
        this.__queue__P_141_0.unshift(widget);
        this.__lookup__P_141_1[widget.toHashCode()] = widget;
      ...
      has: function has(widget) {
        return !!this.__lookup__P_141_1[widget.toHashCode()];
      },
      /**
      ...
      flush: function flush() {
        ...
        var queue = this.__queue__P_141_0;
        var obj;
        for (var i = queue.length - 1; i >= 0; i--) {
          // Order is important to allow the same widget to be re-queued directly
          obj = queue[i];
          queue.splice(i, 1);
          delete this.__lookup__P_141_1[obj.toHashCode()];
...
//# sourceMappingURL=Appearance.js.map?dt=1747169161474
  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      scheduleFlush: function scheduleFlush(job) {
        ...
        self.__jobs__P_138_2[job] = true;
        if (!self.__scheduled__P_138_0) {
          self.__canceled__P_138_1 = false;
          qx.bom.AnimationFrame.request(function () {
            if (self.__canceled__P_138_1) {
              self.__canceled__P_138_1 = false;
              return;
            }
            self.flush();
          }, self);
          self.__scheduled__P_138_0 = true;
        }
      },
      /**
      ...
      flush: function flush() {
        ...
        if (self.__inFlush__P_138_4) {
          return;
        }
        self.__inFlush__P_138_4 = true;

        // Cancel timeout if called manually
        self.__canceled__P_138_1 = true;
        var jobs = self.__jobs__P_138_2;
        self.__executeAndRescheduleOnError__P_138_5(function () {
          // Process jobs
          ...
          self.__scheduled__P_138_0 = false;
        });
        self.__executeAndRescheduleOnError__P_138_5(function () {
          if (jobs.dispose) {
            delete jobs.dispose;
          ...
          // Clear flag
          self.__inFlush__P_138_4 = false;
        });

        // flush succeeded successfully. Reset retries
        self.__retries__P_138_3 = 0;
      },
      /**
       ...
       */
      __executeAndRescheduleOnError__P_138_5: qx.core.Environment.select("qx.debug", {
        ...
        "false": function _false(callback, finallyCode) {
          ...
          try {
            ...
            self.__scheduled__P_138_0 = false;
            self.__inFlush__P_138_4 = false;
            self.__retries__P_138_3 += 1;
            if (self.__retries__P_138_3 <= self.MAX_RETRIES) {
              self.scheduleFlush();
            } else {
              throw new Error("Fatal Error: Flush terminated " + (self.__retries__P_138_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
            }
            throw e;
          } finally {
            finallyCode();
       ...
       */
      __onUserAction__P_138_6: function __onUserAction__P_138_6(e) {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__onUserAction__P_138_6 : statics.flush);
    }
  });
  qx.ui.core.queue.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1747169161125
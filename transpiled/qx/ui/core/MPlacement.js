...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    statics: {
      __visible__P_166_0: null,
      __direction__P_166_1: "left",
      /**
      ...
      getVisibleElement: function getVisibleElement() {
        return this.__visible__P_166_0;
      },
      /**
      ...
      setMoveDirection: function setMoveDirection(direction) {
        if (direction === "top" || direction === "left") {
          this.__direction__P_166_1 = direction;
        } else {
      ...
      getMoveDirection: function getMoveDirection() {
        return this.__direction__P_166_1;
      }
    },
    properties: {
      /**
    ...
    members: {
      __ptwLiveUpdater__P_166_2: null,
      __ptwLiveDisappearListener__P_166_3: null,
      __ptwLiveUpdateDisappearListener__P_166_4: null,
      /**@type {Record<"top" | "right" | "bottom" | "left", number> | null}*/
      __lastKnownCoords__P_166_5: null,
      __lastKnownSize__P_166_6: null,
      /**
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__cleanupFromLastPlaceToWidgetLiveUpdate__P_166_7();

          // Bind target and livupdate to placeToWidget
          this.__ptwLiveUpdater__P_166_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__ptwLiveUpdater__P_166_2);

          // Remove the listener when the element disappears.
          this.__ptwLiveUpdateDisappearListener__P_166_4 = function () {
            this.__cleanupFromLastPlaceToWidgetLiveUpdate__P_166_7();
          };
          this.addListener("disappear", this.__ptwLiveUpdateDisappearListener__P_166_4, this);
        }
        var coords = target.getContentLocation() || this.getLayoutLocation(target);
        var size = this.__getPlacementSize__P_166_8();
        if (coords != null) {
          ...
          if (boundsAreEqual(coords, this.__lastKnownCoords__P_166_5) && boundsAreEqual(size, this.__lastKnownSize__P_166_6)) {
            return true;
          }
          this.__lastKnownCoords__P_166_5 = coords;
          this.__lastKnownSize__P_166_6 = size;
          this._place(coords);
          return true;
        } else {
          return false;
       ...
       */
      __cleanupFromLastPlaceToWidgetLiveUpdate__P_166_7: function __cleanupFromLastPlaceToWidgetLiveUpdate__P_166_7() {
        if (this.__ptwLiveUpdater__P_166_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__ptwLiveUpdater__P_166_2);
          this.__ptwLiveUpdater__P_166_2 = null;
        }
        if (this.__ptwLiveUpdateDisappearListener__P_166_4) {
          this.removeListener("disappear", this.__ptwLiveUpdateDisappearListener__P_166_4, this);
          this.__ptwLiveUpdateDisappearListener__P_166_4 = null;
        }
      },
      /**
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          // Bind target and livupdate to placeToWidget
          this.__ptwLiveUpdater__P_166_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__ptwLiveUpdater__P_166_2);

          // Remove the listener when the element disappears.
          this.addListener("disappear", function () {
            if (_this.__ptwLiveUpdater__P_166_2) {
              qx.event.Idle.getInstance().removeListener("interval", _this.__ptwLiveUpdater__P_166_2);
              _this.__ptwLiveUpdater__P_166_2 = null;
            }
          });
        }
        this._place(coords);
       ...
       */
      __getPlacementSize__P_166_8: function __getPlacementSize__P_166_8(callback) {
        var _this2 = this;
        var size = null;
        ...
        if (size == null) {
          this.addListenerOnce("appear", function () {
            _this2.__getPlacementSize__P_166_8(callback);
          });
        } else {
      ...
      _place: function _place(coords) {
        this.__getPlacementSize__P_166_8(function (size) {
...
//# sourceMappingURL=MPlacement.js.map?dt=1747169163533
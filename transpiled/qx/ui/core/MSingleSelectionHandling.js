  ...
  qx.Mixin.define("qx.ui.core.MSingleSelectionHandling", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      setValue: function setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__getManager__P_183_1().setSelected(item);
          return null;
        } else {
      ...
      getValue: function getValue() {
        return this.__getManager__P_183_1().getSelected() || null;
      },
      /**
       * resetValue implements part of the {@link qx.ui.form.IField} interface.
       */
      resetValue: function resetValue() {
        this.__getManager__P_183_1().resetSelected();
      },
      /**
      ...
      getSelection: function getSelection() {
        var selected = this.__getManager__P_183_1().getSelected();
        if (selected) {
          return [selected];
        } else {
          return [];
      ...
      setSelection: function setSelection(items) {
        switch (items.length) {
          case 0:
            ...
            break;
          case 1:
            this.__getManager__P_183_1().setSelected(items[0]);
            break;
          default:
      ...
      isSelected: function isSelected(item) {
        return this.__getManager__P_183_1().isSelected(item);
      },
      /**
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__getManager__P_183_1().isSelectionEmpty();
      },
      /**
      ...
      getSelectables: function getSelectables(all) {
        return this.__getManager__P_183_1().getSelectables(all);
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
      ...
      */
       ...
       */
      __getManager__P_183_1: function __getManager__P_183_1() {
        if (this.__manager__P_183_0 == null) {
          var that = this;
          this.__manager__P_183_0 = new qx.ui.core.SingleSelectionManager({
          ...
          this.__manager__P_183_0.addListener("changeSelected", this._onChangeSelected, this);
        }
        this.__manager__P_183_0.setAllowEmptySelection(this._isAllowEmptySelection());
        return this.__manager__P_183_0;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__manager__P_183_0");
    }
  });
  qx.ui.core.MSingleSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MSingleSelectionHandling.js.map?dt=1747169165004
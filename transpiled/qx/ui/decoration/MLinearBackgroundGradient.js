  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function _styleLinearBackgroundGradient(styles) {
        ...
        var styleImpl = this.__styleLinearBackgroundGradientAccordingToSpec__P_205_0;
        if (qx.core.Environment.get("css.gradient.legacywebkit")) {
          styleImpl = this.__styleLinearBackgroundGradientForLegacyWebkit__P_205_1;
        } else if (!qx.core.Environment.get("css.gradient.linear") && qx.core.Environment.get("css.borderradius")) {
          styleImpl = this.__styleLinearBackgroundGradientWithCanvas__P_205_2;
        } else if (!qx.core.Environment.get("css.gradient.linear")) {
          styleImpl = this.__styleLinearBackgroundGradientWithMSFilter__P_205_3;
        }
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__getColor__P_205_4(startColors[i]);
            var endColor = this.__getColor__P_205_4(endColors[i]);
            var unit = units[i];
       ...
       */
      __styleLinearBackgroundGradientForLegacyWebkit__P_205_1: function __styleLinearBackgroundGradientForLegacyWebkit__P_205_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __styleLinearBackgroundGradientWithCanvas__P_205_2: function __styleLinearBackgroundGradientWithCanvas__P_205_2(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        var me = qx.ui.decoration.MLinearBackgroundGradient.__styleLinearBackgroundGradientWithCanvas__P_205_2;
        if (!me.__canvas__P_205_5) {
          me.__canvas__P_205_5 = document.createElement("canvas");
        }
        ...
        me.__canvas__P_205_5.width = width;
        me.__canvas__P_205_5.height = height;
        var ctx = me.__canvas__P_205_5.getContext("2d");
        if (isVertical) {
        ...
        backgroundStyle.push("url(" + me.__canvas__P_205_5.toDataURL() + ") " + size);
        return true;
      },
      /**
       * Compute CSS rules to style the background with gradients.
       ...
       */
      __styleLinearBackgroundGradientWithMSFilter__P_205_3: function __styleLinearBackgroundGradientWithMSFilter__P_205_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __styleLinearBackgroundGradientAccordingToSpec__P_205_0: function __styleLinearBackgroundGradientAccordingToSpec__P_205_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       */
      __getColor__P_205_4: function __getColor__P_205_4(color) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1747169166665
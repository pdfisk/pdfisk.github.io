    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        config.patch = this.__normalizeArray__P_7_0(config.patch);
        ...
        this.__initializeAliases__P_7_3(theme, config);
      ...
      */
      ...
      __convert__P_7_2: function __convert__P_7_2(theme, config) {
        var type = this.__extractType__P_7_4(config);
...
//# sourceMappingURL=Theme.js.map?dt=1747169146231
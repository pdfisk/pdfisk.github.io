    ...
    */
    ...
    statics: {
      ...
      getApplication: function getApplication() {
        return this.__application__P_41_0 || null;
      },
      /**
      ...
      ready: function ready() {
        ...
        if (clazz) {
          this.__application__P_41_0 = new clazz();
          var start = new Date();
          this.__application__P_41_0.main();
          if (qx.core.Environment.get("qx.debug.startupTimings")) {
            qx.log.Logger.debug(this, "Main runtime: " + (new Date() - start) + "ms");
          }
          var start = new Date();
          this.__application__P_41_0.finalize();
          if (qx.core.Environment.get("qx.debug.startupTimings")) {
       ...
       */
      __close__P_41_1: function __close__P_41_1(e) {
        var app = this.__application__P_41_0;
        if (app) {
          app.close();
        }
      },
       ...
       *
       */
      __shutdown__P_41_2: function __shutdown__P_41_2() {
        var app = this.__application__P_41_0;
        if (app) {
          app.terminate();
        }
...
//# sourceMappingURL=BaseInit.js.map?dt=1747169150892
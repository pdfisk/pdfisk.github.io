  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    ...
    members: {
      __Property__P_14_0: true ? qx.core.Property : null,
      /*
      ---------------------------------------------------------------------------
        BASICS
      ---------------------------------------------------------------------------
      ...
      */
      ...
      clone: function clone() {
        ...
        var user = this.__Property__P_14_0.$$store.user;
        var setter = this.__Property__P_14_0.$$method.set;
        var name;
      ...
      */
      ...
      setUserData: function setUserData(key, value) {
        if (!this.__userData__P_14_1) {
          this.__userData__P_14_1 = {};
        }
        this.__userData__P_14_1[key] = value;
      },
      /**
      ...
      getUserData: function getUserData(key) {
        ...
        var data = this.__userData__P_14_1[key];
    ...
    */
    destruct: function destruct() {
      ...
      // only of properties are available
      {
        ...
        var clazz = this.constructor;
        var properties;
        var store = this.__Property__P_14_0.$$store;
...
//# sourceMappingURL=Object.js.map?dt=1747169147999
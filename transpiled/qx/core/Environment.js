  ...
  qx.Bootstrap.define("qx.core.Environment", {
    statics: {
      ...
      set: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key, value) {
        ...
        if (this.__environmentBackup__P_10_3 === undefined) {
          ...
          this.__environmentBackup__P_10_3 = Object.assign({}, this.__cache__P_10_0);
          this.__checksBackup__P_10_4 = Object.assign({}, this._checks);
        }
        this.__cache__P_10_0[key] = value;
      ...
      remove: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (this.__environmentBackup__P_10_3 === undefined || this.__environmentBackup__P_10_3[key] === undefined) {
      ...
      reset: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (key !== undefined && this.__environmentBackup__P_10_3[key] === undefined) {
          throw new TypeError("Environment setting \"".concat(key, "\" does not exist."));
        }
        if (key === undefined) {
          // reset all keys
          this.__cache__P_10_0 = Object.assign({}, this.__environmentBackup__P_10_3);
          this._checks = Object.assign({}, this.__checksBackup__P_10_4);
          return;
        }
        // only reset the particular key 
        this.__cache__P_10_0[key] = this.__environmentBackup__P_10_3[key];
        this._checks[key] = this.__checksBackup__P_10_4[key];
      } : undefined,
      /**
       ...
       */
      __importFromGenerator__P_10_5: function __importFromGenerator__P_10_5() {
       ...
       * Environment class.
       */
      __importFromUrl__P_10_6: function __importFromUrl__P_10_6() {
    ...
    defer: function defer(statics) {
      ...
      statics.__importFromGenerator__P_10_5();
      // load the checks from the url
      if (statics.get("qx.allowUrlSettings") === true) {
        statics.__importFromUrl__P_10_6();
      }
    },
    environment: {
      /**
...
//# sourceMappingURL=Environment.js.map?dt=1747169147322
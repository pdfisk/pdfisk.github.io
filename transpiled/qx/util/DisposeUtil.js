    ...
    statics: {
      ...
      destroyContainer: function destroyContainer(container) {
        {
          if (qx.ui.mobile && container instanceof qx.ui.mobile.core.Widget) {
            qx.core.Assert.assertTrue(this.__isChildrenContainer__P_45_0(container), "Container must be an instance of qx.ui.mobile.container.Composite.");
          } else {
            qx.core.Assert.assertQxWidget(container, "First argument must be a container widget!");
            qx.core.Assert.assertTrue(this.__isChildrenContainer__P_45_0(container), "Container must be an instance of qx.ui.container.Composite or qx.ui.container.Scroll or qx.ui.container.Resizer or qx.ui.container.SlideBar or qx.ui.container.Stack!");
          }
        }
        var arr = [];
      ...
      _collectContainerChildren: function _collectContainerChildren(container, arr) {
        ...
        for (var i = 0; i < children.length; i++) {
          var item = children[i];
          arr.push(item);
          if (this.__isChildrenContainer__P_45_0(item)) {
       ...
       * child widgets
       */
      __isChildrenContainer__P_45_0: function __isChildrenContainer__P_45_0(obj) {
        var classes = [];
...
//# sourceMappingURL=DisposeUtil.js.map?dt=1747169151561
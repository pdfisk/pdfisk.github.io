    ...
    members: {
      ...
      _preprocess: function _preprocess(value) {
        ...
        if (dynamics[value] === false) {
          ...
          if (this.__aliases__P_174_0[value]) {
            return this.__aliases__P_174_0[value];
          }
          var alias = value.substring(0, value.indexOf("/"));
          var resolved = this.__aliases__P_174_0[alias];
      ...
      add: function add(alias, base) {
        ...
        this.__aliases__P_174_0[alias] = base;
      ...
      remove: function remove(alias) {
        delete this.__aliases__P_174_0[alias];
      ...
      getAliases: function getAliases() {
        var res = {};
        for (var key in this.__aliases__P_174_0) {
          res[key] = this.__aliases__P_174_0[key];
        }
        return res;
      }
    }
...
//# sourceMappingURL=AliasManager.js.map?dt=1747169164065
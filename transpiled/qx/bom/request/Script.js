  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      this.__initXhrProperties__P_147_0();
      this.__onNativeLoadBound__P_147_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__onNativeErrorBound__P_147_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__onTimeoutBound__P_147_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__headElement__P_147_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__supportsErrorHandler__P_147_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
       ...
       */
      __determineSuccess__P_147_6: null,
      /**
      ...
      open: function open(method, url) {
        if (this.__disposed__P_147_7) {
          return;
        }

        // Reset XHR properties that may have been set by previous request
        this.__initXhrProperties__P_147_0();
        this.__abort__P_147_8 = null;
        this.__url__P_147_9 = url;
        if (this.__environmentGet__P_147_10("qx.debug.io")) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__url__P_147_9 = qx.util.Uri.appendParamsToUrl(this.__url__P_147_9, param);
        return this;
      },
      /**
       * Sends request.
      ...
      send: function send() {
        ...
        var script = this.__createScriptElement__P_147_11(),
          head = this.__headElement__P_147_4,
          that = this;
        if (this.timeout > 0) {
          this.__timeoutId__P_147_12 = window.setTimeout(this.__onTimeoutBound__P_147_3, this.timeout);
        }
        if (this.__environmentGet__P_147_10("qx.debug.io")) {
      ...
      abort: function abort() {
        ...
        this.__abort__P_147_8 = true;
        this.__disposeScriptElement__P_147_13();
        this._emit("abort");
        return this;
      },
      /**
      ...
      getResponseHeader: function getResponseHeader(key) {
        ...
        if (this.__environmentGet__P_147_10("qx.debug")) {
      ...
      setDetermineSuccess: function setDetermineSuccess(check) {
        this.__determineSuccess__P_147_6 = check;
      },
      /**
       * Dispose object.
       */
      dispose: function dispose() {
        var script = this.__scriptElement__P_147_14;
        if (!this.__disposed__P_147_7) {
          ...
          if (this.__timeoutId__P_147_12) {
            window.clearTimeout(this.__timeoutId__P_147_12);
          }
          this.__disposed__P_147_7 = true;
        }
      },
      /**
      ...
      isDisposed: function isDisposed() {
        return !!this.__disposed__P_147_7;
      },
      /*
      ---------------------------------------------------------------------------
        PROTECTED
      ...
      */
      ...
      _getScriptElement: function _getScriptElement() {
        return this.__scriptElement__P_147_14;
      },
      /**
       * Handle timeout.
       */
      _onTimeout: function _onTimeout() {
        this.__failure__P_147_15();
        if (!this.__supportsErrorHandler__P_147_5()) {
          this._emit("error");
        }
        this._emit("timeout");
        if (!this.__supportsErrorHandler__P_147_5()) {
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__scriptElement__P_147_14,
          determineSuccess = this.__determineSuccess__P_147_6,
          that = this;

        // Aborted request must not fire load
        if (this.__abort__P_147_8) {
          return;
        }
        ...
        if (this.__environmentGet__P_147_10("engine.name") === "mshtml" && this.__environmentGet__P_147_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __scriptElement__P_147_14: null,
      /**
       * @type {Element} Head element
       */
      __headElement__P_147_4: null,
      /**
       * @type {String} URL
       */
      __url__P_147_9: "",
      ...
      */
       ...
       */
      __initXhrProperties__P_147_0: function __initXhrProperties__P_147_0() {
        this.readyState = 0;
        this.status = 0;
        this.statusText = "";
      },
       ...
       * Handle failure.
       */
      __failure__P_147_15: function __failure__P_147_15() {
        this.__disposeScriptElement__P_147_13();
        this.readyState = 4;
        this.status = 0;
       ...
       */
      __supportsErrorHandler__P_147_5: function __supportsErrorHandler__P_147_5() {
        var isLegacyIe = this.__environmentGet__P_147_10("engine.name") === "mshtml" && this.__environmentGet__P_147_10("browser.documentmode") < 9;
        var isOpera = this.__environmentGet__P_147_10("engine.name") === "opera";
       ...
       */
      __createScriptElement__P_147_11: function __createScriptElement__P_147_11() {
        var script = this.__scriptElement__P_147_14 = document.createElement("script");
        script.src = this.__url__P_147_9;
        script.onerror = this.__onNativeErrorBound__P_147_2;
        script.onload = this.__onNativeLoadBound__P_147_1;

        // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event
        if (this.__environmentGet__P_147_10("engine.name") === "mshtml" && this.__environmentGet__P_147_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__onNativeLoadBound__P_147_1;
        }
        return script;
      },
      /**
       ...
       */
      __disposeScriptElement__P_147_13: function __disposeScriptElement__P_147_13() {
        var script = this.__scriptElement__P_147_14;
        if (script && script.parentNode) {
          this.__headElement__P_147_4.removeChild(script);
        }
      },
      /**
       ...
       */
      __environmentGet__P_147_10: function __environmentGet__P_147_10(key) {
...
//# sourceMappingURL=Script.js.map?dt=1747169161791
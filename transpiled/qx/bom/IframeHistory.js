  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.IframeHistory", {
    ...
    construct: function construct() {
      ...
      this.__initTimer__P_88_0();
    },
    members: {
      __iframe__P_88_1: null,
      __iframeReady__P_88_2: false,
      __writeStateTimner__P_88_3: null,
      __dontApplyState__P_88_4: null,
      __locationState__P_88_5: null,
      // overridden
      _setInitialState: function _setInitialState() {
        qx.bom.IframeHistory.superclass.prototype._setInitialState.call(this);
        this.__locationState__P_88_5 = this._getHash();
      },
      //overridden
      _setHash: function _setHash(value) {
        qx.bom.IframeHistory.superclass.prototype._setHash.call(this, value);
        this.__locationState__P_88_5 = this._encode(value);
      },
      //overridden
      ...
      _setState: function _setState(state) {
        this.__dontApplyState__P_88_4 = true;
        this.setState(state);
        this.__dontApplyState__P_88_4 = false;
      },
      //overridden
      _applyState: function _applyState(value, old) {
        if (this.__dontApplyState__P_88_4) {
          return;
        }
      ...
      _readState: function _readState() {
        if (!this.__iframeReady__P_88_2) {
          return this._decode(this._getHash());
        }
        var doc = this.__iframe__P_88_1.contentWindow.document;
      ...
      _writeState: function _writeState(state) {
        if (!this.__iframeReady__P_88_2) {
          this.__clearWriteSateTimer__P_88_6();
          this.__writeStateTimner__P_88_3 = qx.event.Timer.once(function () {
       ...
       */
      __clearWriteSateTimer__P_88_6: function __clearWriteSateTimer__P_88_6() {
        if (this.__writeStateTimner__P_88_3) {
          this.__writeStateTimner__P_88_3.stop();
          this.__writeStateTimner__P_88_3.dispose();
        }
      },
      /**
       * Initialize the polling timer
       */
      __initTimer__P_88_0: function __initTimer__P_88_0() {
        this.__initIframe__P_88_7(function () {
          qx.event.Idle.getInstance().addListener("interval", this.__onHashChange__P_88_8, this);
        });
      },
      /**
       ...
       */
      __onHashChange__P_88_8: function __onHashChange__P_88_8(e) {
        // the location only changes if the user manually changes the fragment
        // identifier.
        var currentState = null;
        var locationState = this._getHash();
        if (!this.__isCurrentLocationState__P_88_9(locationState)) {
          currentState = this.__storeLocationState__P_88_10(locationState);
        } else {
       ...
       * @return {String}
       */
      __storeLocationState__P_88_10: function __storeLocationState__P_88_10(locationState) {
       ...
       * @return {Boolean}
       */
      __isCurrentLocationState__P_88_9: function __isCurrentLocationState__P_88_9(locationState) {
        return qx.lang.Type.isString(locationState) && locationState == this.__locationState__P_88_5;
      },
      /**
       ...
       */
      __initIframe__P_88_7: function __initIframe__P_88_7(handler) {
        this.__iframe__P_88_1 = this.__createIframe__P_88_11();
        document.body.appendChild(this.__iframe__P_88_1);
        this.__waitForIFrame__P_88_12(function () {
       ...
       */
      __createIframe__P_88_11: function __createIframe__P_88_11() {
       ...
       */
      __waitForIFrame__P_88_12: function __waitForIFrame__P_88_12(callback, context, retry) {
        if (typeof retry === "undefined") {
          retry = 0;
        }
        if (!this.__iframe__P_88_1.contentWindow || !this.__iframe__P_88_1.contentWindow.document) {
          if (retry > 20) {
            throw new Error("can't initialize iframe");
          }
          qx.event.Timer.once(function () {
            this.__waitForIFrame__P_88_12(callback, context, ++retry);
          }, this, 10);
          return;
        }
        this.__iframeReady__P_88_2 = true;
        callback.call(context || window);
      }
    },
    destruct: function destruct() {
      this.__iframe__P_88_1 = null;
      if (this.__writeStateTimner__P_88_3) {
        this.__writeStateTimner__P_88_3.dispose();
        this.__writeStateTimner__P_88_3 = null;
      }
      qx.event.Idle.getInstance().removeListener("interval", this.__onHashChange__P_88_8, this);
    }
  });
  qx.bom.IframeHistory.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=IframeHistory.js.map?dt=1747169157265
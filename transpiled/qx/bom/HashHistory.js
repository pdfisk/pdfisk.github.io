  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.HashHistory", {
    ...
    construct: function construct() {
      ...
      this._baseUrl = null;
      this.__initIframe__P_87_0();
    },
    members: {
      __checkOnHashChange__P_87_1: null,
      __iframe__P_87_2: null,
      __iframeReady__P_87_3: false,
      //overridden
       ...
       *
       */
      __initIframe__P_87_0: function __initIframe__P_87_0() {
        this.__iframe__P_87_2 = this.__createIframe__P_87_4();
        document.body.appendChild(this.__iframe__P_87_2);
        this.__waitForIFrame__P_87_5(function () {
          this._baseUrl = this.__iframe__P_87_2.contentWindow.document.location.href;
          this.__attachListeners__P_87_6();
        }, this);
      },
      /**
       ...
       * @return {Element}
       */
      __createIframe__P_87_4: function __createIframe__P_87_4() {
       ...
       */
      __waitForIFrame__P_87_5: function __waitForIFrame__P_87_5(callback, context, retry) {
        if (typeof retry === "undefined") {
          retry = 0;
        }
        if (!this.__iframe__P_87_2.contentWindow || !this.__iframe__P_87_2.contentWindow.document) {
          if (retry > 20) {
            throw new Error("can't initialize iframe");
          }
          qx.event.Timer.once(function () {
            this.__waitForIFrame__P_87_5(callback, context, ++retry);
          }, this, 10);
          return;
        }
        this.__iframeReady__P_87_3 = true;
        callback.call(context || window);
      },
      /**
       * Attach hash change listeners
       */
      __attachListeners__P_87_6: function __attachListeners__P_87_6() {
        qx.event.Idle.getInstance().addListener("interval", this.__onHashChange__P_87_7, this);
      },
      /**
       * Remove hash change listeners
       */
      __detatchListeners__P_87_8: function __detatchListeners__P_87_8() {
        qx.event.Idle.getInstance().removeListener("interval", this.__onHashChange__P_87_7, this);
      },
      /**
       * hash change event handler
       */
      __onHashChange__P_87_7: function __onHashChange__P_87_7() {
      ...
      _getHash: function _getHash() {
        if (!this.__iframeReady__P_87_3) {
          return null;
        }
        return this.__iframe__P_87_2.contentWindow.document.location.hash;
      },
      /**
      ...
      _setHash: function _setHash(value) {
        if (!this.__iframe__P_87_2 || !this._baseUrl) {
          return;
        }
        var hash = !this.__iframe__P_87_2.contentWindow.document.location.hash ? "" : this.__iframe__P_87_2.contentWindow.document.location.hash.substr(1);
        if (value != hash) {
          this.__iframe__P_87_2.contentWindow.document.location.hash = value;
        }
      }
    },
    destruct: function destruct() {
      this.__detatchListeners__P_87_8();
      this.__iframe__P_87_2 = null;
    }
  });
  qx.bom.HashHistory.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HashHistory.js.map?dt=1747169157213
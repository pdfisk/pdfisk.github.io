  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        this.__normalizeDesc__P_159_6(desc);
        ...
        if (this.__cssAnimationKeys__P_159_5 != null) {
          ...
          el.style[qx.lang.String.camelCase(this.__cssAnimationKeys__P_159_5["name"])] = style;
       ...
       * @param desc {Map} The description of the animation.
       */
      __validateDesc__P_159_7: qx.core.Environment.select("qx.debug", {
...
//# sourceMappingURL=AnimationCss.js.map?dt=1747169162784
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Manipulating", {
    statics: {
       ...
       */
      __animateScroll__P_148_0: function __animateScroll__P_148_0(property, value, duration) {
       ...
       * @internal
       */
      __getCollectionFromArgument__P_148_1: function __getCollectionFromArgument__P_148_1(arg) {
        var coll;
       ...
       * @internal
       */
      __getInnermostElement__P_148_2: function __getInnermostElement__P_148_2(element) {
        if (element.childNodes.length == 0) {
          return element;
        }
        for (var i = 0, l = element.childNodes.length; i < l; i++) {
          if (element.childNodes[i].nodeType === 1) {
            return this.__getInnermostElement__P_148_2(element.childNodes[i]);
          }
        }
        return element;
      },
       ...
       * @internal
       */
      __getElementArray__P_148_3: function __getElementArray__P_148_3(arg) {
        if (!qx.lang.Type.isArray(arg)) {
    ...
    members: {
      ...
      appendTo: function appendTo(parent) {
        parent = qx.module.Manipulating.__getElementArray__P_148_3(parent);
      ...
      insertBefore: function insertBefore(target) {
        target = qx.module.Manipulating.__getElementArray__P_148_3(target);
      ...
      wrap: function wrap(wrapper) {
        wrapper = qx.module.Manipulating.__getCollectionFromArgument__P_148_1(wrapper);
        if (wrapper.length == 0) {
          return this;
        }
        this._forEachElement(function (item) {
          ...
          var innermost = qx.module.Manipulating.__getInnermostElement__P_148_2(clonedwrapper[0]);
      ...
      setScrollLeft: function setScrollLeft(value, duration) {
        ...
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__animateScroll__P_148_0.bind(this, "scrollLeft", value, duration)();
        }
      ...
      setScrollTop: function setScrollTop(value, duration) {
        var Node = qx.dom.Node;
        if (duration && qx.bom.element && qx.bom.element.AnimationJs) {
          qx.module.Manipulating.__animateScroll__P_148_0.bind(this, "scrollTop", value, duration)();
        }
        for (var i = 0, l = this.length, obj; i < l; i++) {
          obj = this[i];
          if (Node.isElement(obj)) {
...
//# sourceMappingURL=Manipulating.js.map?dt=1747169161944
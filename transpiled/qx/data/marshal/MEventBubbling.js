    ...
    members: {
      ...
      _registerEventChaining: function _registerEventChaining(value, old, name) {
        ...
        if (value instanceof qx.core.Object && qx.Class.hasMixin(value.constructor, qx.data.marshal.MEventBubbling)) {
          // create the listener
          var listener = qx.lang.Function.bind(this.__changePropertyListener__P_124_0, this, name);
       ...
       *   change.
       */
      __changePropertyListener__P_124_0: function __changePropertyListener__P_124_0(name, e) {
        var data = e.getData();
...
//# sourceMappingURL=MEventBubbling.js.map?dt=1747169160239
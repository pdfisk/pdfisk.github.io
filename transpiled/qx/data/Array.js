  ...
  qx.Class.define("qx.data.Array", {
    ...
    construct: function construct(param) {
      ...
      if (param == undefined) {
        ...
        for (var i = 0; i < arguments.length; i++) {
          this.__array__P_81_0.push(arguments[i]);
        }

        // check for a number (length)
      } else if (typeof param == "number") {
        this.__array__P_81_0 = new Array(param);
        // check for an array itself
      } else if (param instanceof Array) {
        this.__array__P_81_0 = qx.lang.Array.clone(param);
      ...
      // propagate changes
      for (var i = 0; i < this.__array__P_81_0.length; i++) {
        this._applyEventPropagation(this.__array__P_81_0[i], null, i);
      }

      // update the length at startup
      this.__updateLength__P_81_1();
    ...
    */
    ...
    members: {
      ...
      concat: function concat(array) {
        ...
        if (array) {
          var newArray = this.__array__P_81_0.concat(array);
        } else {
          var newArray = this.__array__P_81_0.concat();
        }
      ...
      join: function join(connector) {
        return this.__array__P_81_0.join(connector);
      },
      /**
       ...
       */
      pop: function pop() {
        var item = this.__array__P_81_0.pop();
        this.__updateLength__P_81_1();
      ...
      reverse: function reverse() {
        ...
        var oldArray = this.__array__P_81_0.concat();
        this.__array__P_81_0.reverse();
        this.__updateEventPropagation__P_81_2(0, this.length);
        this.fireDataEvent("change", {
          start: 0,
          end: this.length - 1,
          type: "order",
        ...
        // fire change bubbles event
        this.fireDataEvent("changeBubble", {
          value: this.__array__P_81_0,
          name: "0-" + (this.__array__P_81_0.length - 1),
          old: oldArray,
          item: this
        });
      },
      ...
      shift: function shift() {
        ...
        var item = this.__array__P_81_0.shift();
        this.__updateLength__P_81_1();
        // remove the possible added event listener
        this._registerEventChaining(null, item, this.length - 1);
      ...
      slice: function slice(from, to) {
        return new qx.data.Array(this.__array__P_81_0.slice(from, to));
      },
      /**
      ...
      splice: function splice(startIndex, amount, varargs) {
        ...
        var oldLength = this.__array__P_81_0.length;

        // invoke the slice on the array
        var returnArray = this.__array__P_81_0.splice.apply(this.__array__P_81_0, arguments);

        // fire a change event for the length
        if (this.__array__P_81_0.length != oldLength) {
          this.__updateLength__P_81_1();
        ...
        this.__updateEventPropagation__P_81_2(startIndex + (arguments.length - 2) - amount, this.length);
      ...
      sort: function sort(func) {
        ...
        var oldArray = this.__array__P_81_0.concat();
        this.__array__P_81_0.sort.apply(this.__array__P_81_0, arguments);

        // prevent changeBubble event if nothing has been changed
        if (qx.lang.Array.equals(this.__array__P_81_0, oldArray) === true) {
          return;
        }
        this.__updateEventPropagation__P_81_2(0, this.length);
        this.fireDataEvent("change", {
      ...
      unshift: function unshift(varargs) {
        for (var i = arguments.length - 1; i >= 0; i--) {
          this.__array__P_81_0.unshift(arguments[i]);
          this.__updateLength__P_81_1();
          ...
          // fire change bubbles event
          this.fireDataEvent("changeBubble", {
            value: [this.__array__P_81_0[0]],
            name: "0",
            old: [this.__array__P_81_0[1]],
            item: this
          });
      ...
      getItem: function getItem(index) {
        return this.__array__P_81_0[index];
      },
      /**
      ...
      setItem: function setItem(index, item) {
        var oldItem = this.__array__P_81_0[index];
        // ignore settings of already set items [BUG #4106]
        if (oldItem === item) {
          return;
        }
        this.__array__P_81_0[index] = item;
        ...
        if (this.length != this.__array__P_81_0.length) {
          this.__updateLength__P_81_1();
        }
      ...
      indexOf: function indexOf(item) {
        return this.__array__P_81_0.indexOf(item);
      },
      /**
      ...
      lastIndexOf: function lastIndexOf(item) {
        return this.__array__P_81_0.lastIndexOf(item);
      },
      /**
      ...
      toString: function toString() {
        if (this.__array__P_81_0 != null) {
          return this.__array__P_81_0.toString();
        }
        return "";
      },
      /*
      ...
      */
      ...
      includes: function includes(item) {
        return this.__array__P_81_0.indexOf(item) !== -1;
      },
      /**
      ...
      removeAll: function removeAll() {
        ...
        for (var i = 0; i < this.__array__P_81_0.length; i++) {
          this._registerEventChaining(null, this.__array__P_81_0[i], i);
        }
        ...
        var items = this.__array__P_81_0.concat();

        // change the length
        this.__array__P_81_0.length = 0;
        this.__updateLength__P_81_1();
      ...
      append: function append(array) {
        ...
        var oldLength = this.__array__P_81_0.length;
        Array.prototype.push.apply(this.__array__P_81_0, array);
      ...
      forEach: function forEach(callback, context) {
        var _this2 = this;
        this.__array__P_81_0.forEach(function (element, index) {
      ...
      */
      ...
      filter: function filter(callback, self) {
        return new qx.data.Array(this.__array__P_81_0.filter(callback, self));
      },
      /**
      ...
      map: function map(callback, self) {
        return new qx.data.Array(this.__array__P_81_0.map(callback, self));
      },
      /**
      ...
      find: function find(callback, self) {
        return this.__array__P_81_0.find(callback, self);
      },
      /**
      ...
      some: function some(callback, self) {
        return this.__array__P_81_0.some(callback, self);
      },
      /**
      ...
      every: function every(callback, self) {
        return this.__array__P_81_0.every(callback, self);
      },
      /**
      ...
      reduce: function reduce(callback, initValue) {
        return this.__array__P_81_0.reduce(callback, initValue);
      },
      /**
       * Apply a function against an accumulator and each value of the array
      ...
      reduceRight: function reduceRight(callback, initValue) {
        return this.__array__P_81_0.reduceRight(callback, initValue);
      },
      /*
      ---------------------------------------------------------------------------
        INTERNAL HELPERS
      ...
      */
       ...
       * event will be fired.
       */
      __updateLength__P_81_1: function __updateLength__P_81_1() {
        var oldLength = this.length;
        this.length = this.__array__P_81_0.length;
       ...
       */
      __updateEventPropagation__P_81_2: function __updateEventPropagation__P_81_2(from, to) {
        for (var i = from; i < to; i++) {
          this._registerEventChaining(this.__array__P_81_0[i], this.__array__P_81_0[i], i);
        }
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      for (var i = 0; i < this.__array__P_81_0.length; i++) {
        var item = this.__array__P_81_0[i];
...
//# sourceMappingURL=Array.js.map?dt=1747169155760
    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var createdFonts = this.__initialiseFonts__P_192_0(theme.fonts);
        ...
        {
          if (theme) {
            if (!this.__warnedMissingFonts__P_192_1) {
              this.__warnedMissingFonts__P_192_1 = {};
            }
            if (!this.__warnedMissingFonts__P_192_1[value]) {
              this.__warnedMissingFonts__P_192_1[value] = true;
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.fonts[value]) {
          var fontClass = this.__getFontClass__P_192_2(theme.fonts[value]);
       ...
       */
      __resolveInclude__P_192_3: function __resolveInclude__P_192_3(fonts, fontName) {
        if (fonts[fontName].include) {
          ...
          this.__resolveInclude__P_192_3(fonts, fontName);
        }
      },
      /**
       ...
       */
      __initialiseFonts__P_192_0: function __initialiseFonts__P_192_0(fontDefs) {
        var _this = this;
        var webFontDefs = [];
        var createdFonts = {};
        var _loop = function _loop() {
            ...
            if (fontDef.include && fontDefs[fontDef.include]) {
              _this.__resolveInclude__P_192_3(fontDefs, fontId);
            }
            if (fontDef.fontName) {
            ...
            fontClass = _this.__getFontClass__P_192_2(fontDef);
      ...
      _applyTheme: function _applyTheme(value) {
        ...
        if (value) {
          ...
          createdFonts = this.__initialiseFonts__P_192_0(fonts);
        }
       ...
       * @return {Class}
       */
      __getFontClass__P_192_2: function __getFontClass__P_192_2(config) {
...
//# sourceMappingURL=Font.js.map?dt=1747169165497
  ...
  qx.Class.define("qx.theme.manager.Appearance", {
    ...
    */
    construct: function construct() {
      ...
      this.__styleCache__P_142_0 = {};
      this.__aliasMap__P_142_1 = {};
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
       ...
       */
      __defaultStates__P_142_2: {},
      __styleCache__P_142_0: null,
      __aliasMap__P_142_1: null,
      // property apply
      ...
      */
       ...
       */
      __resolveId__P_142_3: function __resolveId__P_142_3(id, theme, defaultId, chain) {
        ...
        if (!entry) {
          ...
          while (!entry && splitted.length > 0) {
            ...
            if (entry) {
              ...
              if (typeof alias === "string") {
                ...
                return this.__resolveId__P_142_3(mapped, theme, defaultId, chainCopy);
              }
            }
          }
          ...
          for (var i = 0; i < end.length - 1; i++) {
            ...
            var resolved = this.__resolveId__P_142_3(subId, theme, null, chainCopy);
            if (resolved) {
              return resolved;
            }
          }
          ...
          if (defaultId != null) {
            return this.__resolveId__P_142_3(defaultId, theme, null, chainCopy);
          }
          ...
          return this.__resolveId__P_142_3(entry, theme, defaultId, chainCopy);
        } else if (entry.include && !entry.style) {
          return this.__resolveId__P_142_3(entry.include, theme, defaultId, chainCopy);
        }
        return id;
      },
      /**
      ...
      styleFrom: function styleFrom(id, states, theme, defaultId) {
        ...
        // Resolve ID
        var aliasMap = this.__aliasMap__P_142_1;
        if (!aliasMap[theme.name]) {
          aliasMap[theme.name] = {};
        }
        var resolved = aliasMap[theme.name][id];
        if (!resolved) {
          resolved = aliasMap[theme.name][id] = this.__resolveId__P_142_3(id, theme, defaultId);
        }
        ...
        var cache = this.__styleCache__P_142_0;
        ...
        if (!states) {
          states = this.__defaultStates__P_142_2;
        }
...
//# sourceMappingURL=Appearance.js.map?dt=1747169161525
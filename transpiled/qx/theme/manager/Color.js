  ...
  qx.Class.define("qx.theme.manager.Color", {
    ...
    */
    ...
    members: {
      _applyTheme: function _applyTheme(value) {
        ...
        if (value) {
          ...
          for (var name in colors) {
            if (!dest[name]) {
              dest[name] = this.__parseColor__P_140_0(colors, name);
            }
          }
        }
      },
       ...
       */
      __parseColor__P_140_0: function __parseColor__P_140_0(colors, name) {
        var color = colors[name];
        if (typeof color === "string") {
          if (!qx.util.ColorUtil.isCssString(color)) {
            // check for references to in theme colors
            if (colors[color] != undefined) {
              return this.__parseColor__P_140_0(colors, color);
            }
          ...
          return this.__parseColor__P_140_0(colors, color(name));
        }
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.colors[value]) {
          return cache[value] = this.__parseColor__P_140_0(theme.colors, value);
        }
        return value;
      },
      /**
      ...
      isDynamic: function isDynamic(value) {
        ...
        if (theme !== null && value && theme.colors[value] !== undefined) {
          cache[value] = this.__parseColor__P_140_0(theme.colors, value);
          return true;
        }
        return false;
      }
...
//# sourceMappingURL=Color.js.map?dt=1747169161449